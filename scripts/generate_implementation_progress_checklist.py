...
STATUS: dict[str, tuple[str, str]] = {
    ...
    "MOD-330-BE-003": ("partial", "outbox on submit/decide/override"),
    "MOD-330-BE-004": ("done", "problem+json via shared handler"),
    "MOD-330-API-001": ("done", "/api/v1/approvals endpoints"),
    "MOD-330-API-002": ("partial", "core action APIs"),
    "MOD-330-API-003": ("partial", "schemas present"),
    ...
    "MOD-330-WF-001": ("partial", "submit/decide/delegate/override"),
    "MOD-330-WF-002": ("n/a", "Temporal deferred"),
    "MOD-330-WF-003": ("partial", "outbox on submit/decide/override"),
    "MOD-330-WF-004": ("n/a", "notifications deferred"),
    "MOD-330-SEC-001": ("partial", "org scope + human decider"),
    "MOD-330-SEC-002": ("done", "RLS on apr_* tables"),
    "MOD-330-SEC-003": ("partial", "audit omits sensitive payload"),
    ...
    "MOD-330-QA-003": ("partial", "agent/self-recommendation negatives"),
    ...
    "MOD-340-BE-003": ("partial", "outbox on create/close/overdue"),
    "MOD-340-BE-004": ("done", "problem+json via shared handler"),
    "MOD-340-API-001": ("done", "/api/v1/follow-ups endpoints"),
    "MOD-340-API-002": ("partial", "core action APIs"),
    "MOD-340-API-003": ("partial", "schemas present"),
    ...
    "MOD-340-WF-001": ("partial", "create/remind/escalate/close"),
    "MOD-340-WF-002": ("n/a", "Temporal timers deferred to MOD-350"),
    "MOD-340-WF-003": ("partial", "outbox on create/close/overdue"),
    "MOD-340-WF-004": ("n/a", "notifications deferred to MOD-440"),
    "MOD-340-SEC-001": ("partial", "org scope"),
    "MOD-340-SEC-002": ("done", "RLS on flu_* tables"),
    "MOD-340-SEC-003": ("partial", "audit omits sensitive payload"),
    ...
    "MOD-340-QA-003": ("partial", "parent close negatives"),
