...
STATUS: dict[str, tuple[str, str]] = {
    ...
    "MOD-200-FE-001": ("done", "clients desk /clients"),
    "MOD-200-FE-002": ("done", "clients desk /clients"),
    "MOD-200-FE-003": ("done", "clients desk /clients"),
    "MOD-200-FE-004": ("done", "clients desk /clients"),
    ...
    "MOD-210-FE-001": ("done", "queries desk /queries"),
    "MOD-210-FE-002": ("done", "queries desk /queries"),
    "MOD-210-FE-003": ("done", "queries desk /queries"),
    "MOD-210-FE-004": ("done", "queries desk /queries"),
    ...
    "MOD-220-FE-001": ("done", "comms desk /comms"),
    "MOD-220-FE-002": ("done", "comms desk /comms"),
    "MOD-220-FE-003": ("done", "comms desk /comms"),
    "MOD-220-FE-004": ("done", "comms desk /comms"),
    ...
    "MOD-230-FE-001": ("done", "requirements desk /requirements"),
    "MOD-230-FE-002": ("done", "requirements desk /requirements"),
    "MOD-230-FE-003": ("done", "requirements desk /requirements"),
    "MOD-230-FE-004": ("done", "requirements desk /requirements"),
    ...
    "MOD-240-FE-001": ("done", "projects desk /projects"),
    "MOD-240-FE-002": ("done", "projects desk /projects"),
    "MOD-240-FE-003": ("done", "projects desk /projects"),
    "MOD-240-FE-004": ("done", "projects desk /projects"),
    ...
    "MOD-250-MP-001": ("done", "doc_documents"),
    "MOD-250-MP-002": ("done", "doc_document_versions"),
    "MOD-250-MP-003": ("done", "doc_templates"),
    "MOD-250-MP-004": ("done", "doc_template_versions"),
    "MOD-250-MP-005": ("done", "doc_attachments"),
    "MOD-250-MP-006": ("done", "doc_document_permissions"),
    "MOD-250-MP-007": ("done", "doc_scan_results"),
    "MOD-250-DB-001": ("done", "migration 20260811_0014 doc_documents"),
    "MOD-250-DB-002": ("done", "doc_document_versions"),
    "MOD-250-DB-003": ("done", "doc_templates"),
    "MOD-250-DB-004": ("done", "doc_template_versions"),
    "MOD-250-DB-005": ("done", "doc_attachments"),
    "MOD-250-DB-006": ("done", "doc_document_permissions"),
    "MOD-250-DB-007": ("done", "doc_scan_results"),
    "MOD-250-BE-001": ("done", "DocumentsService"),
    "MOD-250-BE-002": ("done", "scan gate + access checks + available metadata"),
    "MOD-250-BE-003": ("partial", "outbox on scan record"),
    "MOD-250-BE-004": ("done", "problem+json via shared handler"),
    "MOD-250-API-001": ("done", "/api/v1/documents endpoints"),
    "MOD-250-API-002": ("partial", "CRUD-lite actions"),
    "MOD-250-API-003": ("partial", "schemas present"),
    "MOD-250-FE-001": ("done", "documents desk /documents"),
    "MOD-250-FE-002": ("done", "documents desk /documents"),
    "MOD-250-FE-003": ("done", "documents desk /documents"),
    "MOD-250-FE-004": ("done", "documents desk /documents"),
    "MOD-250-WF-001": ("partial", "scan->quarantine/available flow"),
    "MOD-250-WF-002": ("n/a", "Temporal deferred"),
    "MOD-250-WF-003": ("partial", "outbox on scan"),
    "MOD-250-WF-004": ("n/a", "notifications deferred"),
    "MOD-250-SEC-001": ("partial", "org/client/project scope"),
    "MOD-250-SEC-002": ("done", "RLS on doc_* tables"),
    "MOD-250-SEC-003": ("partial", "audit omits file contents"),
    "MOD-250-SEC-004": ("done", "audit on create/scan/available/permission"),
    "MOD-250-QA-001": ("done", "tests/unit/documents"),
    "MOD-250-QA-002": ("done", "tests/integration/documents"),
    "MOD-250-QA-003": ("partial", "permission denials + client scope"),
    "MOD-250-QA-004": ("partial", "scan stub; no real AV"),
    "MOD-250-QA-005": ("done", "ruff/mypy/pytest"),
    "MOD-250-DOC-001": ("done", "docs/modules/MOD-250/README.md"),
    "MOD-250-DOC-002": ("done", "VERIFICATION + TEMPLATE_TASK_RATIONALE"),
    "MOD-250-AC-001": ("done", "available versions require owner/status/version/effective_at"),
    "MOD-250-AC-002": ("done", "unsafe scans quarantine; indexing blocked"),
    "MOD-250-AC-003": ("done", "access-check for download/preview/extract/embeddings"),
    "MOD-250-AC-900": ("done", "No Critical/High MOD-250 defects filed"),
    "MOD-250-AC-901": ("blocked", "Human owner approval required"),
    "MOD-260-MP-001": ("done", "pm_phases"),
    "MOD-260-MP-002": ("done", "pm_milestones"),
    "MOD-260-MP-003": ("done", "pm_deliverables"),
    "MOD-260-MP-004": ("done", "pm_phase_dependencies"),
    "MOD-260-MP-005": ("done", "pm_project_baselines + requirement maps"),
    "MOD-260-MP-006": ("done", "pm_forecasts"),
    "MOD-260-DB-001": ("done", "migration 20260811_0015 pm_phases"),
    "MOD-260-DB-002": ("done", "pm_milestones"),
    "MOD-260-DB-003": ("done", "pm_deliverables"),
    "MOD-260-DB-004": ("done", "pm_phase_dependencies"),
    "MOD-260-DB-005": ("done", "pm_project_baselines"),
    "MOD-260-DB-006": ("done", "pm_forecasts"),
    "MOD-260-BE-001": ("done", "RoadmapService"),
    "MOD-260-BE-002": ("done", "mapping/milestone approval/independent completion"),
    "MOD-260-BE-003": ("partial", "outbox on phase complete"),
    "MOD-260-BE-004": ("done", "problem+json via shared handler"),
    "MOD-260-API-001": ("done", "/api/v1/roadmap endpoints"),
    "MOD-260-API-002": ("partial", "CRUD-lite actions"),
    "MOD-260-API-003": ("partial", "schemas present"),
    "MOD-260-FE-001": ("done", "roadmap desk /roadmap"),
    "MOD-260-FE-002": ("done", "roadmap desk /roadmap"),
    "MOD-260-FE-003": ("done", "roadmap desk /roadmap"),
    "MOD-260-FE-004": ("done", "roadmap desk /roadmap"),
    "MOD-260-WF-001": ("partial", "phase/milestone complete flow"),
    "MOD-260-WF-002": ("n/a", "Temporal deferred"),
    "MOD-260-WF-003": ("partial", "outbox on phase complete"),
    "MOD-260-WF-004": ("n/a", "notifications deferred"),
    "MOD-260-SEC-001": ("partial", "org/client/project scope"),
    "MOD-260-SEC-002": ("done", "RLS on pm_* tables"),
    "MOD-260-SEC-003": ("partial", "audit omits verbose snapshots"),
    "MOD-260-SEC-004": ("done", "audit on create/approve/complete/map"),
    "MOD-260-QA-001": ("done", "tests/unit/roadmap"),
    "MOD-260-QA-002": ("done", "tests/integration/roadmap"),
    "MOD-260-QA-003": ("partial", "project scope checks in service"),
    "MOD-260-QA-004": ("n/a", "no Temporal suite"),
    "MOD-260-QA-005": ("done", "ruff/mypy/pytest"),
    "MOD-260-DOC-001": ("done", "docs/modules/MOD-260/README.md"),
    "MOD-260-DOC-002": ("done", "VERIFICATION + TEMPLATE_TASK_RATIONALE"),
    "MOD-260-AC-001": ("done", "approved requirements must map to phases"),
    "MOD-260-AC-002": ("done", "milestones require owner/date/status/approval"),
    "MOD-260-AC-003": ("done", "independent phase completion except deps"),
    "MOD-260-AC-900": ("done", "No Critical/High MOD-260 defects filed"),
    "MOD-260-AC-901": ("blocked", "Human owner approval required"),
    "MOD-300-MP-001": ("done", "tkt_tickets"),
    "MOD-300-MP-002": ("done", "tkt_subtasks"),
    "MOD-300-MP-003": ("done", "tkt_ticket_dependencies"),
    "MOD-300-MP-004": ("done", "tkt_requirement_links"),
    "MOD-300-MP-005": ("done", "tkt_ticket_evidence"),
    "MOD-300-MP-006": ("done", "tkt_readiness_checks"),
    "MOD-300-MP-007": ("done", "tkt_done_checks"),
    "MOD-300-DB-001": ("done", "migration 20260811_0016 tkt_tickets"),
    "MOD-300-DB-002": ("done", "tkt_subtasks"),
    "MOD-300-DB-003": ("done", "tkt_ticket_dependencies"),
    "MOD-300-DB-004": ("done", "tkt_requirement_links"),
    "MOD-300-DB-005": ("done", "tkt_ticket_evidence"),
    "MOD-300-DB-006": ("done", "tkt_readiness_checks"),
    "MOD-300-DB-007": ("done", "tkt_done_checks"),
    "MOD-300-BE-001": ("done", "TicketService"),
    "MOD-300-BE-002": ("done", "ready/done/reopen/version guards"),
    "MOD-300-BE-003": ("partial", "outbox on ready/done/reopen/transition"),
    "MOD-300-BE-004": ("done", "problem+json via shared handler"),
    "MOD-300-API-001": ("done", "/api/v1/tickets endpoints"),
    "MOD-300-API-002": ("partial", "CRUD-lite + project list"),
    "MOD-300-API-003": ("partial", "schemas present"),
    "MOD-300-FE-001": ("done", "tickets desk /tickets"),
    "MOD-300-FE-002": ("done", "tickets desk /tickets"),
    "MOD-300-FE-003": ("done", "tickets desk /tickets"),
    "MOD-300-FE-004": ("done", "tickets desk /tickets"),
    "MOD-300-WF-001": ("partial", "status transition matrix + Ready/Done gates"),
    "MOD-300-WF-002": ("n/a", "Temporal deferred"),
    "MOD-300-WF-003": ("partial", "outbox on key transitions"),
    "MOD-300-WF-004": ("n/a", "notifications deferred"),
    "MOD-300-SEC-001": ("partial", "org/client/project scope"),
    "MOD-300-SEC-002": ("done", "RLS on tkt_* tables"),
    "MOD-300-SEC-003": ("partial", "audit omits sensitive payloads"),
    "MOD-300-SEC-004": ("done", "audit on create/update/transition/reopen/evidence"),
    "MOD-300-QA-001": ("done", "tests/unit/tickets"),
    "MOD-300-QA-002": ("done", "tests/integration/tickets"),
    "MOD-300-QA-003": ("partial", "project scope checks in service"),
    "MOD-300-QA-004": ("n/a", "no Temporal suite"),
    "MOD-300-QA-005": ("done", "ruff/mypy/pytest"),
    "MOD-300-DOC-001": ("done", "Docs/modules/MOD-300/README.md"),
    "MOD-300-DOC-002": ("done", "VERIFICATION + TEMPLATE_TASK_RATIONALE"),
    "MOD-300-AC-001": ("done", "Ready requires DoR fields + readiness checks"),
    "MOD-300-AC-002": ("done", "project/phase/owner-or-queue/requirement links"),
    "MOD-300-AC-003": ("done", "Done reopen needs human + reason + evidence"),
    "MOD-300-AC-900": ("done", "No Critical/High MOD-300 defects filed"),
    "MOD-300-AC-901": ("blocked", "Human owner approval required"),
    "MOD-310-MP-001": ("done", "asg_assignments"),
    "MOD-310-MP-002": ("done", "asg_assignment_recommendations"),
    "MOD-310-MP-003": ("done", "asg_allocation_history"),
    "MOD-310-MP-004": ("done", "asg_acknowledgments"),
    "MOD-310-MP-005": ("done", "asg_reassignment_history"),
    "MOD-310-DB-001": ("done", "migration 20260811_0017 asg_assignments"),
    "MOD-310-DB-002": ("done", "asg_assignment_recommendations"),
    "MOD-310-DB-003": ("done", "asg_allocation_history"),
    "MOD-310-DB-004": ("done", "asg_acknowledgments"),
    "MOD-310-DB-005": ("done", "asg_reassignment_history"),
    "MOD-310-BE-001": ("done", "AssignmentService"),
    "MOD-310-BE-002": ("done", "member/availability/override/version guards"),
    "MOD-310-BE-003": ("partial", "outbox on create/reassign"),
    "MOD-310-BE-004": ("done", "problem+json via shared handler"),
    "MOD-310-API-001": ("done", "/api/v1/assignments endpoints"),
    "MOD-310-API-002": ("partial", "ticket-scoped lists"),
    "MOD-310-API-003": ("partial", "schemas present"),
    "MOD-310-FE-001": ("n/a", "assignment desk deferred"),
    "MOD-310-FE-002": ("n/a", "assignment desk deferred"),
    "MOD-310-FE-003": ("n/a", "assignment desk deferred"),
    "MOD-310-FE-004": ("n/a", "assignment desk deferred"),
    "MOD-310-WF-001": ("partial", "assign/ack/reassign flow"),
    "MOD-310-WF-002": ("n/a", "Temporal deferred"),
    "MOD-310-WF-003": ("partial", "outbox on create/reassign"),
    "MOD-310-WF-004": ("n/a", "notifications deferred"),
    "MOD-310-SEC-001": ("partial", "org/client/project scope"),
    "MOD-310-SEC-002": ("done", "RLS on asg_* tables"),
    "MOD-310-SEC-003": ("partial", "audit omits sensitive payload"),
    "MOD-310-SEC-004": ("done", "audit on create/recommend/ack/reassign"),
    "MOD-310-QA-001": ("done", "tests/unit/assignments"),
    "MOD-310-QA-002": ("done", "tests/integration/assignments"),
    "MOD-310-QA-003": ("partial", "membership negative tests"),
    "MOD-310-QA-004": ("n/a", "no Temporal suite"),
    "MOD-310-QA-005": ("done", "ruff/mypy/pytest"),
    "MOD-310-DOC-001": ("done", "Docs/modules/MOD-310/README.md"),
    "MOD-310-DOC-002": ("done", "VERIFICATION + TEMPLATE_TASK_RATIONALE"),
    "MOD-310-AC-001": ("done", "unauthorized/unavailable blocked"),
    "MOD-310-AC-002": ("done", "override requires reason"),
    "MOD-310-AC-003": ("done", "allocation/reassignment history append-only"),
    "MOD-310-AC-900": ("done", "No Critical/High MOD-310 defects filed"),
    "MOD-310-AC-901": ("blocked", "Human owner approval required"),
    "MOD-320-MP-001": ("done", "wfe_workflow_bindings"),
    "MOD-320-MP-002": ("done", "transition evaluator over effective cfg_*"),
    "MOD-320-MP-003": ("done", "wfe_status_history"),
    "MOD-320-MP-004": ("done", "wfe_holds"),
    "MOD-320-MP-005": ("done", "wfe_reopens"),
    "MOD-320-MP-006": ("done", "wfe_available_actions"),
    "MOD-320-DB-001": ("done", "migration 20260811_0018 wfe_workflow_bindings"),
    "MOD-320-DB-002": ("done", "evaluator uses cfg_transition_rules"),
    "MOD-320-DB-003": ("done", "wfe_status_history"),
    "MOD-320-DB-004": ("done", "wfe_holds"),
    "MOD-320-DB-005": ("done", "wfe_reopens"),
    "MOD-320-DB-006": ("done", "wfe_available_actions"),
    "MOD-320-BE-001": ("done", "StatusEngineService"),
    "MOD-320-BE-002": ("done", "hold/approval/reason/version guards"),
    "MOD-320-BE-003": ("partial", "outbox on transition/hold/reopen"),
    "MOD-320-BE-004": ("done", "problem+json via shared handler"),
    "MOD-320-API-001": ("done", "/api/v1/status-engine endpoints"),
    "MOD-320-API-002": ("partial", "core action APIs"),
    "MOD-320-API-003": ("partial", "schemas present"),
    "MOD-320-FE-001": ("n/a", "status engine desk deferred"),
    "MOD-320-FE-002": ("n/a", "status engine desk deferred"),
    "MOD-320-FE-003": ("n/a", "status engine desk deferred"),
    "MOD-320-FE-004": ("n/a", "status engine desk deferred"),
    "MOD-320-WF-001": ("partial", "resolve/evaluate/transition/hold/reopen"),
    "MOD-320-WF-002": ("n/a", "Temporal deferred"),
    "MOD-320-WF-003": ("partial", "outbox on transition/hold/reopen"),
    "MOD-320-WF-004": ("n/a", "notifications deferred"),
    "MOD-320-SEC-001": ("partial", "org scope + actor kind gates"),
    "MOD-320-SEC-002": ("done", "RLS on wfe_* tables"),
    "MOD-320-SEC-003": ("partial", "audit omits unnecessary payload"),
    "MOD-320-SEC-004": ("done", "audit on init/transition/hold/reopen"),
    "MOD-320-QA-001": ("done", "tests/unit/statusengine"),
    "MOD-320-QA-002": ("done", "tests/integration/statusengine"),
    "MOD-320-QA-003": ("partial", "agent approval-gate negative tests"),
    "MOD-320-QA-004": ("n/a", "no Temporal suite"),
    "MOD-320-QA-005": ("done", "ruff/mypy/pytest"),
    "MOD-320-DOC-001": ("done", "Docs/modules/MOD-320/README.md"),
    "MOD-320-DOC-002": ("done", "VERIFICATION + TEMPLATE_TASK_RATIONALE"),
    "MOD-320-AC-001": ("done", "string status codes from effective config"),
    "MOD-320-AC-002": ("done", "history + audit on transitions"),
    "MOD-320-AC-003": ("done", "agents cannot skip approval gates"),
    "MOD-320-AC-900": ("done", "No Critical/High MOD-320 defects filed"),
    "MOD-320-AC-901": ("blocked", "Human owner approval required"),
}
