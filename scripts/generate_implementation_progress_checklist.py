...
STATUS: dict[str, tuple[str, str]] = {
    ...
    "MOD-020-BE-001": ("partial", "kernel context+errors; UoW/outbox not yet"),
    ...
    "MOD-020-QA-005": ("partial", "ruff/mypy/pytest for kernel slice"),
    "MOD-020-DOC-001": ("partial", "docs/modules/MOD-020/README.md"),
    "MOD-020-DOC-002": ("partial", "DATA_CONVENTIONS + VERIFICATION"),
    "MOD-020-AC-001": ("partial", "RequestContext in kernel; not all modules migrated yet"),
