      ...
      <header className="border-b border-[var(--line)] bg-[var(--panel)]">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-4 px-4 py-4">
          ...
          <nav aria-label="Primary" className="flex flex-wrap items-center gap-3 text-sm">
            <Link className="underline-offset-4 hover:underline" href="/governance/baselines">
              Baselines
            </Link>
            <label className="flex items-center gap-2">
              ...
              <select
                ...
                onChange={(event) => setVariant(event.target.value as typeof session.variant)}
                aria-label="Governance UI role variant"
              >
