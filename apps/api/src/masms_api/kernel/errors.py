"""Domain and API application errors (MOD-020-MP-004)."""
...
class TenantMismatchError(AppError):
    def __init__(
        self,
        message: str = "Resource is outside the active organization scope",
        *,
        correlation_id: UUID | None = None,
    ) -> None:
        super().__init__("tenant_mismatch", message, 403, correlation_id=correlation_id)
