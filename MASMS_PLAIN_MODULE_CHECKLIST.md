...
**All tasks:** 1749 · done 559 · partial 152 · n/a 157 · blocked 20 · open 861
...
- [x] **Main goals**
  ...
  - [x] Build and verify: transition evaluator (`MOD-320-MP-002`)
  - [x] Build and verify: status history (`MOD-320-MP-003`)
  - [x] Build and verify: hold records (`MOD-320-MP-004`)
  - [x] Build and verify: reopen records (`MOD-320-MP-005`)
  - [x] Build and verify: available next actions (`MOD-320-MP-006`)

- [x] **Database**
  - [x] Design and migrate data for: workflow resolver (`MOD-320-DB-001`)
  - [x] Design and migrate data for: transition evaluator (`MOD-320-DB-002`)
  - [x] Design and migrate data for: status history (`MOD-320-DB-003`)
  - [x] Design and migrate data for: hold records (`MOD-320-DB-004`)
