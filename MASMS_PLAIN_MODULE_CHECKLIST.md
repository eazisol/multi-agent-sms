...
- [x] **Main goals**
  ...
  - [x] Build and verify: reminders (`MOD-340-MP-002`)
  - [x] Build and verify: escalations (`MOD-340-MP-003`)
  - [x] Build and verify: parent-child links (`MOD-340-MP-004`)
  - [x] Build and verify: SLA pauses (`MOD-340-MP-005`)
  - [x] Build and verify: business-time deadlines (`MOD-340-MP-006`)
  - [x] Build and verify: closure evidence (`MOD-340-MP-007`)

- [x] **Database**
  - [x] Design and migrate data for: follow-ups (`MOD-340-DB-001`)
  - [x] Design and migrate data for: reminders (`MOD-340-DB-002`)
  - [x] Design and migrate data for: escalations (`MOD-340-DB-003`)
  - [x] Design and migrate data for: parent-child links (`MOD-340-DB-004`)
  - [x] Design and migrate data for: SLA pauses (`MOD-340-DB-005`)
