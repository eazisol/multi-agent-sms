...
**All tasks:** 1749 · done 588 · partial 160 · n/a 164 · blocked 21 · open 816
...
- [x] **Main goals**
  ...
  - [x] Build and verify: approval workflows (`MOD-330-MP-002`)
  - [x] Build and verify: approval steps (`MOD-330-MP-003`)
  - [x] Build and verify: approval decisions (`MOD-330-MP-004`)
  - [x] Build and verify: delegations (`MOD-330-MP-005`)
  - [x] Build and verify: approval evidence (`MOD-330-MP-006`)
  - [x] Build and verify: human overrides (`MOD-330-MP-007`)

- [x] **Database**
  - [x] Design and migrate data for: approvals (`MOD-330-DB-001`)
  - [x] Design and migrate data for: approval workflows (`MOD-330-DB-002`)
  - [x] Design and migrate data for: approval steps (`MOD-330-DB-003`)
  - [x] Design and migrate data for: approval decisions (`MOD-330-DB-004`)
  - [x] Design and migrate data for: delegations (`MOD-330-DB-005`)
