...
| 8 | MOD-120 | Not started | 0 | 0 | 47 |
| 9 | MOD-130 | Not started | 0 | 0 | 47 |
...
M1: [ ] Main goals
     M1-1: [ ] Build and verify: typed identifiers  (MOD-020-MP-001)
     M1-2: [ ] Build and verify: actor context  (MOD-020-MP-002)
     M1-3: [ ] Build and verify: tenant context  (MOD-020-MP-003)
     M1-4: [ ] Build and verify: domain errors  (MOD-020-MP-004)
...
M2: [ ] Database
     M2-1: [ ] Design and migrate data for: typed identifiers  (MOD-020-DB-001)
     M2-2: [ ] Design and migrate data for: actor context  (MOD-020-DB-002)
     M2-3: [ ] Design and migrate data for: tenant context  (MOD-020-DB-003)
     M2-4: [ ] Design and migrate data for: domain errors  (MOD-020-DB-004)
...
M3: [ ] Backend
     ...
     M3-4: [ ] Return structured errors for validation, forbidden, not found, conflict, invalid transition, and approval required.  (MOD-020-BE-004)
...
M8: [ ] Testing
     M8-1: [ ] Add unit tests for domain rules, validation, conflicts, and invalid state.  (MOD-020-QA-001)
...
M1: [ ] Main goals
     M1-1: [ ] Build and verify: audit logs  (MOD-040-MP-001)
     M1-2: [ ] Build and verify: activity events  (MOD-040-MP-002)
     M1-3: [ ] Build and verify: status history  (MOD-040-MP-003)
     M1-4: [ ] Build and verify: agent runs  (MOD-040-MP-004)
     M1-5: [ ] Build and verify: integration events  (MOD-040-MP-005)
     M1-6: [ ] Build and verify: OpenTelemetry  (MOD-040-MP-006)
     M1-7: [ ] Build and verify: health checks  (MOD-040-MP-007)

M2: [ ] Database
     M2-1: [ ] Design and migrate data for: audit logs  (MOD-040-DB-001)
     M2-2: [ ] Design and migrate data for: activity events  (MOD-040-DB-002)
     M2-3: [ ] Design and migrate data for: status history  (MOD-040-DB-003)
     M2-4: [ ] Design and migrate data for: agent runs  (MOD-040-DB-004)
     M2-5: [ ] Design and migrate data for: integration events  (MOD-040-DB-005)
...
M3: [ ] Backend
     M3-1: [ ] Implement typed domain models, commands, queries, repositories, and application services for the approved scope.  (MOD-040-BE-001)
     ...
     M3-4: [ ] Return structured errors for validation, forbidden, not found, conflict, invalid transition, and approval required.  (MOD-040-BE-004)
...
M7: [ ] Security / audit
     ...
     M7-2: [ ] Add tenant-isolation and project-isolation controls in application services and RLS where applicable.  (MOD-040-SEC-002)
     M7-3: [ ] Minimize and redact PII, secrets, tokens, credentials, and restricted data in logs, prompts, notifications, events, exports, and errors.  (MOD-040-SEC-003)
     M7-4: [ ] Create audit events for create, read-sensitive, update, delete, assignment, transition, approval, rejection, override, export, integration, and agent actions.  (MOD-040-SEC-004)

M8: [ ] Testing
     M8-1: [ ] Add unit tests for domain rules, validation, conflicts, and invalid state.  (MOD-040-QA-001)
     M8-2: [ ] Add integration and API-contract tests for transactions, persistence, errors, concurrency, and idempotency.  (MOD-040-QA-002)
     ...
     M8-5: [ ] Run formatter, lint, type check, tests, migrations, frontend build, and relevant security or performance checks.  (MOD-040-QA-005)

M9: [ ] Docs
     M9-1: [ ] Update module README, data dictionary, API documentation, permissions, status rules, approvals, events, audit catalog, operational notes, and user guidance.  (MOD-040-DOC-001)
     M9-2: [ ] Record migration, rollback, known limitations, verification commands, and evidence references.  (MOD-040-DOC-002)

M10: [ ] Acceptance / Done gate
     M10-1: [ ] Every controlled action is attributable to an actor.  (MOD-040-AC-001)
     M10-2: [ ] Audit records are append-only for operational roles.  (MOD-040-AC-002)
     M10-3: [ ] Failures are diagnosable without revealing secrets.  (MOD-040-AC-003)
     M10-4: [ ] All Critical and High defects for this module are resolved.  (MOD-040-AC-900)
...
M1: [ ] Main goals
     M1-1: [ ] Build and verify: organizations  (MOD-100-MP-001)
     M1-2: [ ] Build and verify: actors  (MOD-100-MP-002)
     M1-3: [ ] Build and verify: human users  (MOD-100-MP-003)
     M1-4: [ ] Build and verify: agents  (MOD-100-MP-004)
     M1-5: [ ] Build and verify: roles  (MOD-100-MP-005)
     M1-6: [ ] Build and verify: departments  (MOD-100-MP-006)
     M1-7: [ ] Build and verify: teams  (MOD-100-MP-007)
     M1-8: [ ] Build and verify: team members  (MOD-100-MP-008)
     M1-9: [ ] Build and verify: reporting lines  (MOD-100-MP-009)

M2: [ ] Database
     M2-1: [ ] Design and migrate data for: organizations  (MOD-100-DB-001)
     M2-2: [ ] Design and migrate data for: actors  (MOD-100-DB-002)
     M2-3: [ ] Design and migrate data for: human users  (MOD-100-DB-003)
     M2-4: [ ] Design and migrate data for: agents  (MOD-100-DB-004)
     M2-5: [ ] Design and migrate data for: roles  (MOD-100-DB-005)
     M2-6: [ ] Design and migrate data for: departments  (MOD-100-DB-006)
     M2-7: [ ] Design and migrate data for: teams  (MOD-100-DB-007)
     M2-8: [ ] Design and migrate data for: team members  (MOD-100-DB-008)
     M2-9: [ ] Design and migrate data for: reporting lines  (MOD-100-DB-009)

M3: [ ] Backend
     M3-1: [ ] Implement typed domain models, commands, queries, repositories, and application services for the approved scope.  (MOD-100-BE-001)
     ...
     M3-4: [ ] Return structured errors for validation, forbidden, not found, conflict, invalid transition, and approval required.  (MOD-100-BE-004)

M4: [ ] API
     M4-1: [ ] Create versioned CRUD, query, transition, action, and history endpoints required by the module.  (MOD-100-API-001)
...
M7: [ ] Security / audit
     ...
     M7-2: [ ] Add tenant-isolation and project-isolation controls in application services and RLS where applicable.  (MOD-100-SEC-002)
     ...
     M7-4: [ ] Create audit events for create, read-sensitive, update, delete, assignment, transition, approval, rejection, override, export, integration, and agent actions.  (MOD-100-SEC-004)

M8: [ ] Testing
     M8-1: [ ] Add unit tests for domain rules, validation, conflicts, and invalid state.  (MOD-100-QA-001)
     M8-2: [ ] Add integration and API-contract tests for transactions, persistence, errors, concurrency, and idempotency.  (MOD-100-QA-002)
     ...
     M8-5: [ ] Run formatter, lint, type check, tests, migrations, frontend build, and relevant security or performance checks.  (MOD-100-QA-005)

M9: [ ] Docs
     M9-1: [ ] Update module README, data dictionary, API documentation, permissions, status rules, approvals, events, audit catalog, operational notes, and user guidance.  (MOD-100-DOC-001)
     M9-2: [ ] Record migration, rollback, known limitations, verification commands, and evidence references.  (MOD-100-DOC-002)

M10: [ ] Acceptance / Done gate
     M10-1: [ ] Every action and owner resolves to one actor.  (MOD-100-AC-001)
     M10-2: [ ] Every operational agent has an active human supervisor.  (MOD-100-AC-002)
     M10-3: [ ] Agent and human identities are separate.  (MOD-100-AC-003)
     M10-4: [ ] All Critical and High defects for this module are resolved.  (MOD-100-AC-900)
...
M1: [ ] Main goals
     M1-1: [ ] Build and verify: identity provider  (MOD-110-MP-001)
     M1-2: [ ] Build and verify: token validation  (MOD-110-MP-002)
     M1-3: [ ] Build and verify: sessions  (MOD-110-MP-003)
     M1-4: [ ] Build and verify: MFA  (MOD-110-MP-004)
     M1-5: [ ] Build and verify: step-up authentication  (MOD-110-MP-005)
     M1-6: [ ] Build and verify: client invitations  (MOD-110-MP-006)
     M1-7: [ ] Build and verify: service identities  (MOD-110-MP-007)

M2: [ ] Database
     M2-1: [ ] Design and migrate data for: identity provider  (MOD-110-DB-001)
     M2-2: [ ] Design and migrate data for: token validation  (MOD-110-DB-002)
     M2-3: [ ] Design and migrate data for: sessions  (MOD-110-DB-003)
     M2-4: [ ] Design and migrate data for: MFA  (MOD-110-DB-004)
     M2-5: [ ] Design and migrate data for: step-up authentication  (MOD-110-DB-005)
     M2-6: [ ] Design and migrate data for: client invitations  (MOD-110-DB-006)
     M2-7: [ ] Design and migrate data for: service identities  (MOD-110-DB-007)

M3: [ ] Backend
     M3-1: [ ] Implement typed domain models, commands, queries, repositories, and application services for the approved scope.  (MOD-110-BE-001)
     ...
     M3-4: [ ] Return structured errors for validation, forbidden, not found, conflict, invalid transition, and approval required.  (MOD-110-BE-004)

M4: [ ] API
     M4-1: [ ] Create versioned CRUD, query, transition, action, and history endpoints required by the module.  (MOD-110-API-001)
...
M7: [ ] Security / audit
     ...
     M7-2: [ ] Add tenant-isolation and project-isolation controls in application services and RLS where applicable.  (MOD-110-SEC-002)
     M7-3: [ ] Minimize and redact PII, secrets, tokens, credentials, and restricted data in logs, prompts, notifications, events, exports, and errors.  (MOD-110-SEC-003)
     M7-4: [ ] Create audit events for create, read-sensitive, update, delete, assignment, transition, approval, rejection, override, export, integration, and agent actions.  (MOD-110-SEC-004)

M8: [ ] Testing
     M8-1: [ ] Add unit tests for domain rules, validation, conflicts, and invalid state.  (MOD-110-QA-001)
     M8-2: [ ] Add integration and API-contract tests for transactions, persistence, errors, concurrency, and idempotency.  (MOD-110-QA-002)
     ...
     M8-5: [ ] Run formatter, lint, type check, tests, migrations, frontend build, and relevant security or performance checks.  (MOD-110-QA-005)

M9: [ ] Docs
     M9-1: [ ] Update module README, data dictionary, API documentation, permissions, status rules, approvals, events, audit catalog, operational notes, and user guidance.  (MOD-110-DOC-001)
     M9-2: [ ] Record migration, rollback, known limitations, verification commands, and evidence references.  (MOD-110-DOC-002)

M10: [ ] Acceptance / Done gate
     M10-1: [ ] All human and machine actions use authenticated actor identities.  (MOD-110-AC-001)
     M10-2: [ ] Privileged actions require appropriate assurance.  (MOD-110-AC-002)
     M10-3: [ ] Sessions can be revoked immediately.  (MOD-110-AC-003)
     M10-4: [ ] All Critical and High defects for this module are resolved.  (MOD-110-AC-900)
...
M1: [ ] Main goals
     M1-1: [ ] Build and verify: permissions  (MOD-120-MP-001)
     M1-2: [ ] Build and verify: role permissions  (MOD-120-MP-002)
     M1-3: [ ] Build and verify: project members  (MOD-120-MP-003)
     M1-4: [ ] Build and verify: module access  (MOD-120-MP-004)
     M1-5: [ ] Build and verify: document access  (MOD-120-MP-005)
     M1-6: [ ] Build and verify: approval authorities  (MOD-120-MP-006)
     M1-7: [ ] Build and verify: RLS policies  (MOD-120-MP-007)
     M1-8: [ ] Build and verify: access reviews  (MOD-120-MP-008)

M2: [ ] Database
     M2-1: [ ] Design and migrate data for: permissions  (MOD-120-DB-001)
     M2-2: [ ] Design and migrate data for: role permissions  (MOD-120-DB-002)
     M2-3: [ ] Design and migrate data for: project members  (MOD-120-DB-003)
     M2-4: [ ] Design and migrate data for: module access  (MOD-120-DB-004)
     M2-5: [ ] Design and migrate data for: document access  (MOD-120-DB-005)
     M2-6: [ ] Design and migrate data for: approval authorities  (MOD-120-DB-006)
     M2-7: [ ] Design and migrate data for: RLS policies  (MOD-120-DB-007)
     M2-8: [ ] Design and migrate data for: access reviews  (MOD-120-DB-008)

M3: [ ] Backend
     M3-1: [ ] Implement typed domain models, commands, queries, repositories, and application services for the approved scope.  (MOD-120-BE-001)
     ...
     M3-4: [ ] Return structured errors for validation, forbidden, not found, conflict, invalid transition, and approval required.  (MOD-120-BE-004)

M4: [ ] API
     M4-1: [ ] Create versioned CRUD, query, transition, action, and history endpoints required by the module.  (MOD-120-API-001)
...
M7: [ ] Security / audit
     ...
     M7-2: [ ] Add tenant-isolation and project-isolation controls in application services and RLS where applicable.  (MOD-120-SEC-002)
     ...
     M7-4: [ ] Create audit events for create, read-sensitive, update, delete, assignment, transition, approval, rejection, override, export, integration, and agent actions.  (MOD-120-SEC-004)

M8: [ ] Testing
     M8-1: [ ] Add unit tests for domain rules, validation, conflicts, and invalid state.  (MOD-120-QA-001)
     M8-2: [ ] Add integration and API-contract tests for transactions, persistence, errors, concurrency, and idempotency.  (MOD-120-QA-002)
     M8-3: [ ] Add role-permission negative tests and tenant/project isolation tests.  (MOD-120-QA-003)
     ...
     M8-5: [ ] Run formatter, lint, type check, tests, migrations, frontend build, and relevant security or performance checks.  (MOD-120-QA-005)

M9: [ ] Docs
     M9-1: [ ] Update module README, data dictionary, API documentation, permissions, status rules, approvals, events, audit catalog, operational notes, and user guidance.  (MOD-120-DOC-001)
     M9-2: [ ] Record migration, rollback, known limitations, verification commands, and evidence references.  (MOD-120-DOC-002)

M10: [ ] Acceptance / Done gate
     M10-1: [ ] No cross-client access exists through API, database, files, cache, vectors, search, or exports.  (MOD-120-AC-001)
     M10-2: [ ] Project access requires valid membership or explicit authority.  (MOD-120-AC-002)
     M10-3: [ ] Frontend visibility never replaces backend authorization.  (MOD-120-AC-003)
     M10-4: [ ] All Critical and High defects for this module are resolved.  (MOD-120-AC-900)
...
M1: [ ] Main goals
     M1-1: [ ] Build and verify: skills  (MOD-130-MP-001)
     M1-2: [ ] Build and verify: actor skills  (MOD-130-MP-002)
     M1-3: [ ] Build and verify: availability  (MOD-130-MP-003)
     M1-4: [ ] Build and verify: capacity allocations  (MOD-130-MP-004)
     M1-5: [ ] Build and verify: business calendars  (MOD-130-MP-005)
     M1-6: [ ] Build and verify: holidays  (MOD-130-MP-006)
     M1-7: [ ] Build and verify: leave periods  (MOD-130-MP-007)
     M1-8: [ ] Build and verify: on-call schedules  (MOD-130-MP-008)

M2: [ ] Database
     M2-1: [ ] Design and migrate data for: skills  (MOD-130-DB-001)
     M2-2: [ ] Design and migrate data for: actor skills  (MOD-130-DB-002)
     M2-3: [ ] Design and migrate data for: availability  (MOD-130-DB-003)
     M2-4: [ ] Design and migrate data for: capacity allocations  (MOD-130-DB-004)
     M2-5: [ ] Design and migrate data for: business calendars  (MOD-130-DB-005)
     M2-6: [ ] Design and migrate data for: holidays  (MOD-130-DB-006)
     M2-7: [ ] Design and migrate data for: leave periods  (MOD-130-DB-007)
     M2-8: [ ] Design and migrate data for: on-call schedules  (MOD-130-DB-008)

M3: [ ] Backend
     M3-1: [ ] Implement typed domain models, commands, queries, repositories, and application services for the approved scope.  (MOD-130-BE-001)
     ...
     M3-4: [ ] Return structured errors for validation, forbidden, not found, conflict, invalid transition, and approval required.  (MOD-130-BE-004)

M4: [ ] API
     M4-1: [ ] Create versioned CRUD, query, transition, action, and history endpoints required by the module.  (MOD-130-API-001)
...
M7: [ ] Security / audit
     ...
     M7-2: [ ] Add tenant-isolation and project-isolation controls in application services and RLS where applicable.  (MOD-130-SEC-002)
     M7-3: [ ] Minimize and redact PII, secrets, tokens, credentials, and restricted data in logs, prompts, notifications, events, exports, and errors.  (MOD-130-SEC-003)
...
M8: [ ] Testing
     M8-1: [ ] Add unit tests for domain rules, validation, conflicts, and invalid state.  (MOD-130-QA-001)
     M8-2: [ ] Add integration and API-contract tests for transactions, persistence, errors, concurrency, and idempotency.  (MOD-130-QA-002)
     ...
     M8-5: [ ] Run formatter, lint, type check, tests, migrations, frontend build, and relevant security or performance checks.  (MOD-130-QA-005)

M9: [ ] Docs
     M9-1: [ ] Update module README, data dictionary, API documentation, permissions, status rules, approvals, events, audit catalog, operational notes, and user guidance.  (MOD-130-DOC-001)
     M9-2: [ ] Record migration, rollback, known limitations, verification commands, and evidence references.  (MOD-130-DOC-002)

M10: [ ] Acceptance / Done gate
     M10-1: [ ] Assignments can evaluate skill, access, capacity, calendar, and deadline.  (MOD-130-AC-001)
     M10-2: [ ] SLA calculations respect business calendars and time zones.  (MOD-130-AC-002)
     M10-3: [ ] Unnecessary personal data is excluded.  (MOD-130-AC-003)
     M10-4: [ ] All Critical and High defects for this module are resolved.  (MOD-130-AC-900)
...
M1: [ ] Main goals
     M1-1: [ ] Build and verify: queries  (MOD-210-MP-001)
     M1-2: [ ] Build and verify: opportunities  (MOD-210-MP-002)
     M1-3: [ ] Build and verify: qualification answers  (MOD-210-MP-003)
     M1-4: [ ] Build and verify: query sources  (MOD-210-MP-004)
     M1-5: [ ] Build and verify: query status history  (MOD-210-MP-005)
     M1-6: [ ] Build and verify: first response SLA  (MOD-210-MP-006)

M2: [ ] Database
     M2-1: [ ] Design and migrate data for: queries  (MOD-210-DB-001)
     M2-2: [ ] Design and migrate data for: opportunities  (MOD-210-DB-002)
     M2-3: [ ] Design and migrate data for: qualification answers  (MOD-210-DB-003)
     M2-4: [ ] Design and migrate data for: query sources  (MOD-210-DB-004)
     M2-5: [ ] Design and migrate data for: query status history  (MOD-210-DB-005)
     M2-6: [ ] Design and migrate data for: first response SLA  (MOD-210-DB-006)

M3: [ ] Backend
     M3-1: [ ] Implement typed domain models, commands, queries, repositories, and application services for the approved scope.  (MOD-210-BE-001)
     M3-2: [ ] Enforce authorization, approval, status-transition, concurrency, and idempotency rules before mutation.  (MOD-210-BE-002)
     ...
     M3-4: [ ] Return structured errors for validation, forbidden, not found, conflict, invalid transition, and approval required.  (MOD-210-BE-004)

M4: [ ] API
     M4-1: [ ] Create versioned CRUD, query, transition, action, and history endpoints required by the module.  (MOD-210-API-001)
...
M7: [ ] Security / audit
     ...
     M7-2: [ ] Add tenant-isolation and project-isolation controls in application services and RLS where applicable.  (MOD-210-SEC-002)
     ...
     M7-4: [ ] Create audit events for create, read-sensitive, update, delete, assignment, transition, approval, rejection, override, export, integration, and agent actions.  (MOD-210-SEC-004)

M8: [ ] Testing
     M8-1: [ ] Add unit tests for domain rules, validation, conflicts, and invalid state.  (MOD-210-QA-001)
     M8-2: [ ] Add integration and API-contract tests for transactions, persistence, errors, concurrency, and idempotency.  (MOD-210-QA-002)
     ...
     M8-5: [ ] Run formatter, lint, type check, tests, migrations, frontend build, and relevant security or performance checks.  (MOD-210-QA-005)

M9: [ ] Docs
     M9-1: [ ] Update module README, data dictionary, API documentation, permissions, status rules, approvals, events, audit catalog, operational notes, and user guidance.  (MOD-210-DOC-001)
     M9-2: [ ] Record migration, rollback, known limitations, verification commands, and evidence references.  (MOD-210-DOC-002)

M10: [ ] Acceptance / Done gate
     M10-1: [ ] Each valid inquiry creates one traceable query.  (MOD-210-AC-001)
     M10-2: [ ] Qualification is reviewable and explainable.  (MOD-210-AC-002)
     M10-3: [ ] Conversion preserves communication, documents, follow-ups, and decisions.  (MOD-210-AC-003)
     M10-4: [ ] All Critical and High defects for this module are resolved.  (MOD-210-AC-900)
...
M1: [ ] Main goals
     M1-1: [ ] Build and verify: conversations  (MOD-220-MP-001)
     M1-2: [ ] Build and verify: messages  (MOD-220-MP-002)
     M1-3: [ ] Build and verify: message revisions  (MOD-220-MP-003)
     M1-4: [ ] Build and verify: recipients  (MOD-220-MP-004)
     M1-5: [ ] Build and verify: delivery receipts  (MOD-220-MP-005)
     M1-6: [ ] Build and verify: attachment links  (MOD-220-MP-006)

M2: [ ] Database
     M2-1: [ ] Design and migrate data for: conversations  (MOD-220-DB-001)
     M2-2: [ ] Design and migrate data for: messages  (MOD-220-DB-002)
     M2-3: [ ] Design and migrate data for: message revisions  (MOD-220-DB-003)
     M2-4: [ ] Design and migrate data for: recipients  (MOD-220-DB-004)
     M2-5: [ ] Design and migrate data for: delivery receipts  (MOD-220-DB-005)
     M2-6: [ ] Design and migrate data for: attachment links  (MOD-220-DB-006)

M3: [ ] Backend
     M3-1: [ ] Implement typed domain models, commands, queries, repositories, and application services for the approved scope.  (MOD-220-BE-001)
     M3-2: [ ] Enforce authorization, approval, status-transition, concurrency, and idempotency rules before mutation.  (MOD-220-BE-002)
     ...
     M3-4: [ ] Return structured errors for validation, forbidden, not found, conflict, invalid transition, and approval required.  (MOD-220-BE-004)

M4: [ ] API
     M4-1: [ ] Create versioned CRUD, query, transition, action, and history endpoints required by the module.  (MOD-220-API-001)
...
M7: [ ] Security / audit
     ...
     M7-2: [ ] Add tenant-isolation and project-isolation controls in application services and RLS where applicable.  (MOD-220-SEC-002)
     ...
     M7-4: [ ] Create audit events for create, read-sensitive, update, delete, assignment, transition, approval, rejection, override, export, integration, and agent actions.  (MOD-220-SEC-004)

M8: [ ] Testing
     M8-1: [ ] Add unit tests for domain rules, validation, conflicts, and invalid state.  (MOD-220-QA-001)
     M8-2: [ ] Add integration and API-contract tests for transactions, persistence, errors, concurrency, and idempotency.  (MOD-220-QA-002)
     ...
     M8-5: [ ] Run formatter, lint, type check, tests, migrations, frontend build, and relevant security or performance checks.  (MOD-220-QA-005)

M9: [ ] Docs
     M9-1: [ ] Update module README, data dictionary, API documentation, permissions, status rules, approvals, events, audit catalog, operational notes, and user guidance.  (MOD-220-DOC-001)
     M9-2: [ ] Record migration, rollback, known limitations, verification commands, and evidence references.  (MOD-220-DOC-002)

M10: [ ] Acceptance / Done gate
     M10-1: [ ] Material communication is linked to the correct entity.  (MOD-220-AC-001)
     M10-2: [ ] Sensitive messages follow approval and recipient rules.  (MOD-220-AC-002)
     M10-3: [ ] Sent-message history is immutable.  (MOD-220-AC-003)
     M10-4: [ ] All Critical and High defects for this module are resolved.  (MOD-220-AC-900)
...
M1: [ ] Main goals
     M1-1: [ ] Build and verify: questionnaires  (MOD-230-MP-001)
     M1-2: [ ] Build and verify: questionnaire versions  (MOD-230-MP-002)
     M1-3: [ ] Build and verify: answers  (MOD-230-MP-003)
     M1-4: [ ] Build and verify: requirement briefs  (MOD-230-MP-004)
     M1-5: [ ] Build and verify: clarification requests  (MOD-230-MP-005)
     M1-6: [ ] Build and verify: completeness scoring  (MOD-230-MP-006)

M2: [ ] Database
     M2-1: [ ] Design and migrate data for: questionnaires  (MOD-230-DB-001)
     M2-2: [ ] Design and migrate data for: questionnaire versions  (MOD-230-DB-002)
     M2-3: [ ] Design and migrate data for: answers  (MOD-230-DB-003)
     M2-4: [ ] Design and migrate data for: requirement briefs  (MOD-230-DB-004)
     M2-5: [ ] Design and migrate data for: clarification requests  (MOD-230-DB-005)
     M2-6: [ ] Design and migrate data for: completeness scoring  (MOD-230-DB-006)

M3: [ ] Backend
     M3-1: [ ] Implement typed domain models, commands, queries, repositories, and application services for the approved scope.  (MOD-230-BE-001)
     M3-2: [ ] Enforce authorization, approval, status-transition, concurrency, and idempotency rules before mutation.  (MOD-230-BE-002)
     ...
     M3-4: [ ] Return structured errors for validation, forbidden, not found, conflict, invalid transition, and approval required.  (MOD-230-BE-004)

M4: [ ] API
     M4-1: [ ] Create versioned CRUD, query, transition, action, and history endpoints required by the module.  (MOD-230-API-001)
...
M7: [ ] Security / audit
     ...
     M7-2: [ ] Add tenant-isolation and project-isolation controls in application services and RLS where applicable.  (MOD-230-SEC-002)
     ...
     M7-4: [ ] Create audit events for create, read-sensitive, update, delete, assignment, transition, approval, rejection, override, export, integration, and agent actions.  (MOD-230-SEC-004)

M8: [ ] Testing
     M8-1: [ ] Add unit tests for domain rules, validation, conflicts, and invalid state.  (MOD-230-QA-001)
     M8-2: [ ] Add integration and API-contract tests for transactions, persistence, errors, concurrency, and idempotency.  (MOD-230-QA-002)
     ...
     M8-5: [ ] Run formatter, lint, type check, tests, migrations, frontend build, and relevant security or performance checks.  (MOD-230-QA-005)

M9: [ ] Docs
     M9-1: [ ] Update module README, data dictionary, API documentation, permissions, status rules, approvals, events, audit catalog, operational notes, and user guidance.  (MOD-230-DOC-001)
     M9-2: [ ] Record migration, rollback, known limitations, verification commands, and evidence references.  (MOD-230-DOC-002)

M10: [ ] Acceptance / Done gate
     M10-1: [ ] At least 95% of mandatory fields are answered or explicitly unavailable.  (MOD-230-AC-001)
     M10-2: [ ] Unanswered mandatory items have an owner or follow-up.  (MOD-230-AC-002)
     M10-3: [ ] The brief is versioned and human-approved.  (MOD-230-AC-003)
     M10-4: [ ] All Critical and High defects for this module are resolved.  (MOD-230-AC-900)
