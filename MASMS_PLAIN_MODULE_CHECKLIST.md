...
| 30 | MOD-440 | Done (M1) | 38 | 2 | 0 |
| 31 | MOD-450 | Done (M1) | 38 | 2 | 0 |
| 32 | MOD-460 | Done (M1) | 36 | 2 | 0 |
| 33 | MOD-500 | Done (M1) | 36 | 2 | 0 |
| 34 | MOD-510 | Done (M1) | 36 | 2 | 0 |
| 35 | MOD-520 | Done (M1) | 36 | 2 | 0 |
| 36 | MOD-600 | Done (M1) | 38 | 2 | 0 |
| 37 | MOD-610 | Done (M1) | 36 | 2 | 0 |
| 38 | MOD-620 | Done (M1) | 34 | 2 | 0 |
| 39 | MOD-630 | Done (M1) | 38 | 2 | 0 |

**All tasks:** 1749 · done 1030 · partial 16 · n/a 212 · blocked 0 · open 491
...
- [x] **Main goals**
  ...
  - [x] Build and verify: workflow signals (`MOD-350-MP-002`)
  - [x] Build and verify: workflow versions (`MOD-350-MP-003`)
  - [x] Build and verify: workflow failures (`MOD-350-MP-004`)
  - [x] Build and verify: interventions (`MOD-350-MP-005`)
  - [x] Build and verify: 12 approved workflows (`MOD-350-MP-006`)

- [x] **Database**
  - [x] Design and migrate data for: workflow instances (`MOD-350-DB-001`)
  - [x] Design and migrate data for: workflow signals (`MOD-350-DB-002`)
  - [x] Design and migrate data for: workflow versions (`MOD-350-DB-003`)
  - [x] Design and migrate data for: workflow failures (`MOD-350-DB-004`)
  - [x] Design and migrate data for: interventions (`MOD-350-DB-005`)
  - [x] Design and migrate data for: 12 approved workflows (`MOD-350-DB-006`)

- [x] **Backend**
  - [x] Implement typed domain models, commands, queries, repositories, and application services for the approved scope. (`MOD-350-BE-001`)
  - [x] Enforce authorization, approval, status-transition, concurrency, and idempotency rules before mutation. (`MOD-350-BE-002`)
  - [x] Publish domain events through the transactionally safe outbox when asynchronous processing is required. (`MOD-350-BE-003`)
  - [x] Return structured errors for validation, forbidden, not found, conflict, invalid transition, and approval required. (`MOD-350-BE-004`)

- [x] **API**
  - [x] Create versioned CRUD, query, transition, action, and history endpoints required by the module. (`MOD-350-API-001`)
  - [x] Add pagination, filtering, sorting, bounded search, optimistic concurrency, idempotency, and standard problem-details errors. (`MOD-350-API-002`)
  - [x] Document request, response, validation, authorization, conflict, approval-required, invalid-transition, and not-found examples in OpenAPI. (`MOD-350-API-003`)
...
- [~] **Workflow / agents / events**
  - [x] Define triggers, owners, inputs, outputs, statuses, transitions, waits, reminders, escalations, approvals, evidence, and closure rules. (`MOD-350-WF-001`)
  ...
  - [x] Define domain events, outbox publication, idempotent consumers, correlation IDs, retries, dead-letter behavior, and replay rules. (`MOD-350-WF-003`)
...
- [x] **Security / audit**
  - [x] Enforce organization, client, project, role, module, action, classification, environment, and effective-date authorization. (`MOD-350-SEC-001`)
  - [x] Add tenant-isolation and project-isolation controls in application services and RLS where applicable. (`MOD-350-SEC-002`)
  - [x] Minimize and redact PII, secrets, tokens, credentials, and restricted data in logs, prompts, notifications, events, exports, and errors. (`MOD-350-SEC-003`)
  - [x] Create audit events for create, read-sensitive, update, delete, assignment, transition, approval, rejection, override, export, integration, and agent actions. (`MOD-350-SEC-004`)

- [x] **Testing**
  - [x] Add unit tests for domain rules, validation, conflicts, and invalid state. (`MOD-350-QA-001`)
  - [x] Add integration and API-contract tests for transactions, persistence, errors, concurrency, and idempotency. (`MOD-350-QA-002`)
  ...
  - [x] Run formatter, lint, type check, tests, migrations, frontend build, and relevant security or performance checks. (`MOD-350-QA-005`)
...
- [x] **Main goals**
  ...
  - [x] Build and verify: knowledge versions (`MOD-370-MP-002`)
  - [x] Build and verify: chunks (`MOD-370-MP-003`)
  - [x] Build and verify: embeddings (`MOD-370-MP-004`)
  - [x] Build and verify: knowledge permissions (`MOD-370-MP-005`)
  - [x] Build and verify: usage logs (`MOD-370-MP-006`)
  - [x] Build and verify: knowledge conflicts (`MOD-370-MP-007`)

- [x] **Database**
  - [x] Design and migrate data for: knowledge items (`MOD-370-DB-001`)
  - [x] Design and migrate data for: knowledge versions (`MOD-370-DB-002`)
  - [x] Design and migrate data for: chunks (`MOD-370-DB-003`)
  - [x] Design and migrate data for: embeddings (`MOD-370-DB-004`)
  - [x] Design and migrate data for: knowledge permissions (`MOD-370-DB-005`)
  - [x] Design and migrate data for: usage logs (`MOD-370-DB-006`)
  - [x] Design and migrate data for: knowledge conflicts (`MOD-370-DB-007`)

- [x] **Backend**
  - [x] Implement typed domain models, commands, queries, repositories, and application services for the approved scope. (`MOD-370-BE-001`)
  - [x] Enforce authorization, approval, status-transition, concurrency, and idempotency rules before mutation. (`MOD-370-BE-002`)
  - [x] Publish domain events through the transactionally safe outbox when asynchronous processing is required. (`MOD-370-BE-003`)
  - [x] Return structured errors for validation, forbidden, not found, conflict, invalid transition, and approval required. (`MOD-370-BE-004`)

- [x] **API**
  - [x] Create versioned CRUD, query, transition, action, and history endpoints required by the module. (`MOD-370-API-001`)
  - [x] Add pagination, filtering, sorting, bounded search, optimistic concurrency, idempotency, and standard problem-details errors. (`MOD-370-API-002`)
  - [x] Document request, response, validation, authorization, conflict, approval-required, invalid-transition, and not-found examples in OpenAPI. (`MOD-370-API-003`)
...
- [~] **Workflow / agents / events**
  - [x] Define triggers, owners, inputs, outputs, statuses, transitions, waits, reminders, escalations, approvals, evidence, and closure rules. (`MOD-370-WF-001`)
  ...
  - [x] Define domain events, outbox publication, idempotent consumers, correlation IDs, retries, dead-letter behavior, and replay rules. (`MOD-370-WF-003`)
...
- [x] **Security / audit**
  - [x] Enforce organization, client, project, role, module, action, classification, environment, and effective-date authorization. (`MOD-370-SEC-001`)
  - [x] Add tenant-isolation and project-isolation controls in application services and RLS where applicable. (`MOD-370-SEC-002`)
  - [x] Minimize and redact PII, secrets, tokens, credentials, and restricted data in logs, prompts, notifications, events, exports, and errors. (`MOD-370-SEC-003`)
  - [x] Create audit events for create, read-sensitive, update, delete, assignment, transition, approval, rejection, override, export, integration, and agent actions. (`MOD-370-SEC-004`)

- [x] **Testing**
  - [x] Add unit tests for domain rules, validation, conflicts, and invalid state. (`MOD-370-QA-001`)
  - [x] Add integration and API-contract tests for transactions, persistence, errors, concurrency, and idempotency. (`MOD-370-QA-002`)
  ...
  - [x] Run formatter, lint, type check, tests, migrations, frontend build, and relevant security or performance checks. (`MOD-370-QA-005`)
...
- [x] **Main goals**
  ...
  - [x] Build and verify: test steps (MOD-400-MP-002)
  - [x] Build and verify: test suites (MOD-400-MP-003)
  - [x] Build and verify: test plans (MOD-400-MP-004)
  - [x] Build and verify: test runs (MOD-400-MP-005)
  - [x] Build and verify: test evidence (MOD-400-MP-006)
  - [x] Build and verify: coverage links (MOD-400-MP-007)

- [x] **Database**
  - [x] Design and migrate data for: test cases (MOD-400-DB-001)
  - [x] Design and migrate data for: test steps (MOD-400-DB-002)
  - [x] Design and migrate data for: test suites (MOD-400-DB-003)
  - [x] Design and migrate data for: test plans (MOD-400-DB-004)
  - [x] Design and migrate data for: test runs (MOD-400-DB-005)
  - [x] Design and migrate data for: test evidence (MOD-400-DB-006)
  - [x] Design and migrate data for: coverage links (MOD-400-DB-007)

- [x] **Backend**
  - [x] Implement typed domain models, commands, queries, repositories, and application services for the approved scope. (MOD-400-BE-001)
  - [x] Enforce authorization, approval, status-transition, concurrency, and idempotency rules before mutation. (MOD-400-BE-002)
  - [x] Publish domain events through the transactionally safe outbox when asynchronous processing is required. (MOD-400-BE-003)
  - [x] Return structured errors for validation, forbidden, not found, conflict, invalid transition, and approval required. (MOD-400-BE-004)

- [x] **API**
  - [x] Create versioned CRUD, query, transition, action, and history endpoints required by the module. (MOD-400-API-001)
  - [x] Add pagination, filtering, sorting, bounded search, optimistic concurrency, idempotency, and standard problem-details errors. (MOD-400-API-002)
  - [x] Document request, response, validation, authorization, conflict, approval-required, invalid-transition, and not-found examples in OpenAPI. (MOD-400-API-003)
...
- [~] **Workflow / agents / events**
  - [x] Define triggers, owners, inputs, outputs, statuses, transitions, waits, reminders, escalations, approvals, evidence, and closure rules. (MOD-400-WF-001)
  ...
  - [x] Define domain events, outbox publication, idempotent consumers, correlation IDs, retries, dead-letter behavior, and replay rules. (MOD-400-WF-003)
...
- [x] **Security / audit**
  - [x] Enforce organization, client, project, role, module, action, classification, environment, and effective-date authorization. (MOD-400-SEC-001)
  - [x] Add tenant-isolation and project-isolation controls in application services and RLS where applicable. (MOD-400-SEC-002)
  - [x] Minimize and redact PII, secrets, tokens, credentials, and restricted data in logs, prompts, notifications, events, exports, and errors. (MOD-400-SEC-003)
  - [x] Create audit events for create, read-sensitive, update, delete, assignment, transition, approval, rejection, override, export, integration, and agent actions. (MOD-400-SEC-004)

- [x] **Testing**
  - [x] Add unit tests for domain rules, validation, conflicts, and invalid state. (MOD-400-QA-001)
  - [x] Add integration and API-contract tests for transactions, persistence, errors, concurrency, and idempotency. (MOD-400-QA-002)
  ...
  - [x] Run formatter, lint, type check, tests, migrations, frontend build, and relevant security or performance checks. (MOD-400-QA-005)
...
- [x] **Main goals**
  ...
  - [x] Build and verify: bug links (MOD-410-MP-002)
  - [x] Build and verify: bug assignments (MOD-410-MP-003)
  - [x] Build and verify: fix submissions (MOD-410-MP-004)
  - [x] Build and verify: retests (MOD-410-MP-005)
  - [x] Build and verify: known issue approvals (MOD-410-MP-006)
  - [x] Build and verify: severity SLA (MOD-410-MP-007)

- [x] **Database**
  - [x] Design and migrate data for: bugs (MOD-410-DB-001)
  - [x] Design and migrate data for: bug links (MOD-410-DB-002)
  - [x] Design and migrate data for: bug assignments (MOD-410-DB-003)
  - [x] Design and migrate data for: fix submissions (MOD-410-DB-004)
  - [x] Design and migrate data for: retests (MOD-410-DB-005)
  - [x] Design and migrate data for: known issue approvals (MOD-410-DB-006)
  - [x] Design and migrate data for: severity SLA (MOD-410-DB-007)

- [x] **Backend**
  - [x] Implement typed domain models, commands, queries, repositories, and application services for the approved scope. (MOD-410-BE-001)
  - [x] Enforce authorization, approval, status-transition, concurrency, and idempotency rules before mutation. (MOD-410-BE-002)
  - [x] Publish domain events through the transactionally safe outbox when asynchronous processing is required. (MOD-410-BE-003)
  - [x] Return structured errors for validation, forbidden, not found, conflict, invalid transition, and approval required. (MOD-410-BE-004)

- [x] **API**
  - [x] Create versioned CRUD, query, transition, action, and history endpoints required by the module. (MOD-410-API-001)
  - [x] Add pagination, filtering, sorting, bounded search, optimistic concurrency, idempotency, and standard problem-details errors. (MOD-410-API-002)
  - [x] Document request, response, validation, authorization, conflict, approval-required, invalid-transition, and not-found examples in OpenAPI. (MOD-410-API-003)
...
- [~] **Workflow / agents / events**
  - [x] Define triggers, owners, inputs, outputs, statuses, transitions, waits, reminders, escalations, approvals, evidence, and closure rules. (MOD-410-WF-001)
  ...
  - [x] Define domain events, outbox publication, idempotent consumers, correlation IDs, retries, dead-letter behavior, and replay rules. (MOD-410-WF-003)
...
- [x] **Security / audit**
  - [x] Enforce organization, client, project, role, module, action, classification, environment, and effective-date authorization. (MOD-410-SEC-001)
  - [x] Add tenant-isolation and project-isolation controls in application services and RLS where applicable. (MOD-410-SEC-002)
  - [x] Minimize and redact PII, secrets, tokens, credentials, and restricted data in logs, prompts, notifications, events, exports, and errors. (MOD-410-SEC-003)
  - [x] Create audit events for create, read-sensitive, update, delete, assignment, transition, approval, rejection, override, export, integration, and agent actions. (MOD-410-SEC-004)

- [x] **Testing**
  - [x] Add unit tests for domain rules, validation, conflicts, and invalid state. (MOD-410-QA-001)
  - [x] Add integration and API-contract tests for transactions, persistence, errors, concurrency, and idempotency. (MOD-410-QA-002)
  ...
  - [x] Run formatter, lint, type check, tests, migrations, frontend build, and relevant security or performance checks. (MOD-410-QA-005)
...
### Module 30: [x] MOD-440 — Notifications, Preferences, Digests, Delivery, and Failure Handling

- [x] **Main goals**
  - [x] Build and verify: notifications (`MOD-440-MP-001`)
  - [x] Build and verify: preferences (`MOD-440-MP-002`)
  - [x] Build and verify: templates (`MOD-440-MP-003`)
  - [x] Build and verify: deliveries (`MOD-440-MP-004`)
  - [x] Build and verify: retries (`MOD-440-MP-005`)
  - [x] Build and verify: dead letters (`MOD-440-MP-006`)
  - [x] Build and verify: digests (`MOD-440-MP-007`)

- [x] **Database**
  - [x] Design and migrate data for: notifications (`MOD-440-DB-001`)
  - [x] Design and migrate data for: preferences (`MOD-440-DB-002`)
  - [x] Design and migrate data for: templates (`MOD-440-DB-003`)
  - [x] Design and migrate data for: deliveries (`MOD-440-DB-004`)
  - [x] Design and migrate data for: retries (`MOD-440-DB-005`)
  - [x] Design and migrate data for: dead letters (`MOD-440-DB-006`)
  - [x] Design and migrate data for: digests (`MOD-440-DB-007`)

- [x] **Backend**
  - [x] Implement typed domain models, commands, queries, repositories, and application services for the approved scope. (`MOD-440-BE-001`)
  - [x] Enforce authorization, approval, status-transition, concurrency, and idempotency rules before mutation. (`MOD-440-BE-002`)
  - [x] Publish domain events through the transactionally safe outbox when asynchronous processing is required. (`MOD-440-BE-003`)
  - [x] Return structured errors for validation, forbidden, not found, conflict, invalid transition, and approval required. (`MOD-440-BE-004`)

- [x] **API**
  - [x] Create versioned CRUD, query, transition, action, and history endpoints required by the module. (`MOD-440-API-001`)
  - [x] Add pagination, filtering, sorting, bounded search, optimistic concurrency, idempotency, and standard problem-details errors. (`MOD-440-API-002`)
  - [x] Document request, response, validation, authorization, conflict, approval-required, invalid-transition, and not-found examples in OpenAPI. (`MOD-440-API-003`)
...
- [~] **Workflow / agents / events**
  - [x] Define triggers, owners, inputs, outputs, statuses, transitions, waits, reminders, escalations, approvals, evidence, and closure rules. (`MOD-440-WF-001`)
  ...
  - [x] Define domain events, outbox publication, idempotent consumers, correlation IDs, retries, dead-letter behavior, and replay rules. (`MOD-440-WF-003`)
  - [x] Define notification recipients, channels, content classification, quiet hours, priority overrides, delivery audit, and failure handling. (`MOD-440-WF-004`)

- [x] **Security / audit**
  - [x] Enforce organization, client, project, role, module, action, classification, environment, and effective-date authorization. (`MOD-440-SEC-001`)
  - [x] Add tenant-isolation and project-isolation controls in application services and RLS where applicable. (`MOD-440-SEC-002`)
  - [x] Minimize and redact PII, secrets, tokens, credentials, and restricted data in logs, prompts, notifications, events, exports, and errors. (`MOD-440-SEC-003`)
  - [x] Create audit events for create, read-sensitive, update, delete, assignment, transition, approval, rejection, override, export, integration, and agent actions. (`MOD-440-SEC-004`)

- [~] **Testing**
  - [x] Add unit tests for domain rules, validation, conflicts, and invalid state. (`MOD-440-QA-001`)
  - [x] Add integration and API-contract tests for transactions, persistence, errors, concurrency, and idempotency. (`MOD-440-QA-002`)
  ...
  - [x] Run formatter, lint, type check, tests, migrations, frontend build, and relevant security or performance checks. (`MOD-440-QA-005`)

- [x] **Docs**
  - [x] Update module README, data dictionary, API documentation, permissions, status rules, approvals, events, audit catalog, operational notes, and user guidance. (`MOD-440-DOC-001`)
  - [x] Record migration, rollback, known limitations, verification commands, and evidence references. (`MOD-440-DOC-002`)

- [x] **Acceptance / Done gate**
  - [x] Notifications are timely, idempotent, auditable, and permission-safe. (`MOD-440-AC-001`)
  - [x] Users can configure preferences without disabling mandatory critical alerts. (`MOD-440-AC-002`)
  - [x] Delivery failures are visible and recoverable. (`MOD-440-AC-003`)
  - [x] All Critical and High defects for this module are resolved. (`MOD-440-AC-900`)
  - [x] The responsible human owner reviews and approves the completion evidence. (`MOD-440-AC-901`)

### Module 31: [x] MOD-450 — Dashboard, Reporting, Search, Project Health, and Activity Timeline
...
- [x] **Acceptance / Done gate**
  ...
  - [x] The responsible human owner reviews and approves the completion evidence. (`MOD-450-AC-901`)

### Module 32: [x] MOD-460 — Requirement Traceability, Audit Reports, and Evidence Exports
...
- [x] **Acceptance / Done gate**
  ...
  - [x] The responsible human owner reviews and approves the completion evidence. (`MOD-460-AC-901`)

## Phase 5 - MVP Integrations

### Module 33: [x] MOD-500 — Integration Framework, OAuth Connections, Webhooks, Outbox, Inbox, and Sync State

- [x] **Main goals**
  - [x] Build and verify: integration connections (`MOD-500-MP-001`)
  - [x] Build and verify: webhook events (`MOD-500-MP-002`)
  - [x] Build and verify: sync cursors (`MOD-500-MP-003`)
  - [x] Build and verify: external mappings (`MOD-500-MP-004`)
  - [x] Build and verify: outbox events (`MOD-500-MP-005`)
  - [x] Build and verify: inbox events (`MOD-500-MP-006`)
  - [x] Build and verify: connection health (`MOD-500-MP-007`)

- [x] **Database**
  - [x] Design and migrate data for: integration connections (`MOD-500-DB-001`)
  - [x] Design and migrate data for: webhook events (`MOD-500-DB-002`)
  - [x] Design and migrate data for: sync cursors (`MOD-500-DB-003`)
  - [x] Design and migrate data for: external mappings (`MOD-500-DB-004`)
  - [x] Design and migrate data for: outbox events (`MOD-500-DB-005`)
  - [x] Design and migrate data for: inbox events (`MOD-500-DB-006`)
  - [x] Design and migrate data for: connection health (`MOD-500-DB-007`)

- [x] **Backend**
  - [x] Implement typed domain models, commands, queries, repositories, and application services for the approved scope. (`MOD-500-BE-001`)
  - [x] Enforce authorization, approval, status-transition, concurrency, and idempotency rules before mutation. (`MOD-500-BE-002`)
  - [x] Publish domain events through the transactionally safe outbox when asynchronous processing is required. (`MOD-500-BE-003`)
  - [x] Return structured errors for validation, forbidden, not found, conflict, invalid transition, and approval required. (`MOD-500-BE-004`)

- [x] **API**
  - [x] Create versioned CRUD, query, transition, action, and history endpoints required by the module. (`MOD-500-API-001`)
  - [x] Add pagination, filtering, sorting, bounded search, optimistic concurrency, idempotency, and standard problem-details errors. (`MOD-500-API-002`)
  - [x] Document request, response, validation, authorization, conflict, approval-required, invalid-transition, and not-found examples in OpenAPI. (`MOD-500-API-003`)
...
- [~] **Workflow / agents / events**
  - [x] Define triggers, owners, inputs, outputs, statuses, transitions, waits, reminders, escalations, approvals, evidence, and closure rules. (`MOD-500-WF-001`)
  ...
  - [x] Define domain events, outbox publication, idempotent consumers, correlation IDs, retries, dead-letter behavior, and replay rules. (`MOD-500-WF-003`)
...
- [x] **Security / audit**
  - [x] Enforce organization, client, project, role, module, action, classification, environment, and effective-date authorization. (`MOD-500-SEC-001`)
  - [x] Add tenant-isolation and project-isolation controls in application services and RLS where applicable. (`MOD-500-SEC-002`)
  - [x] Minimize and redact PII, secrets, tokens, credentials, and restricted data in logs, prompts, notifications, events, exports, and errors. (`MOD-500-SEC-003`)
  - [x] Create audit events for create, read-sensitive, update, delete, assignment, transition, approval, rejection, override, export, integration, and agent actions. (`MOD-500-SEC-004`)

- [x] **Testing**
  - [x] Add unit tests for domain rules, validation, conflicts, and invalid state. (`MOD-500-QA-001`)
  - [x] Add integration and API-contract tests for transactions, persistence, errors, concurrency, and idempotency. (`MOD-500-QA-002`)
  - [x] Add role-permission negative tests and tenant/project isolation tests. (`MOD-500-QA-003`)
  ...
  - [x] Run formatter, lint, type check, tests, migrations, frontend build, and relevant security or performance checks. (`MOD-500-QA-005`)

- [x] **Docs**
  - [x] Update module README, data dictionary, API documentation, permissions, status rules, approvals, events, audit catalog, operational notes, and user guidance. (`MOD-500-DOC-001`)
  - [x] Record migration, rollback, known limitations, verification commands, and evidence references. (`MOD-500-DOC-002`)

- [x] **Acceptance / Done gate**
  - [x] Integration failure cannot corrupt internal data. (`MOD-500-AC-001`)
  - [x] External mappings and events are tenant-scoped and audited. (`MOD-500-AC-002`)
  - [x] Credentials never appear in logs, prompts, tickets, or business tables. (`MOD-500-AC-003`)
  - [x] All Critical and High defects for this module are resolved. (`MOD-500-AC-900`)
  - [x] The responsible human owner reviews and approves the completion evidence. (`MOD-500-AC-901`)

### Module 34: [x] MOD-510 — Gmail Client Communication Integration

- [x] **Main goals**
  - [x] Build and verify: Gmail connection (`MOD-510-MP-001`)
  - [x] Build and verify: history cursor (`MOD-510-MP-002`)
  - [x] Build and verify: thread mappings (`MOD-510-MP-003`)
  - [x] Build and verify: message mappings (`MOD-510-MP-004`)
  - [x] Build and verify: attachment import (`MOD-510-MP-005`)
  - [x] Build and verify: draft review (`MOD-510-MP-006`)
  - [x] Build and verify: approved send (`MOD-510-MP-007`)

- [x] **Database**
  - [x] Design and migrate data for: Gmail connection (`MOD-510-DB-001`)
  - [x] Design and migrate data for: history cursor (`MOD-510-DB-002`)
  - [x] Design and migrate data for: thread mappings (`MOD-510-DB-003`)
  - [x] Design and migrate data for: message mappings (`MOD-510-DB-004`)
  - [x] Design and migrate data for: attachment import (`MOD-510-DB-005`)
  - [x] Design and migrate data for: draft review (`MOD-510-DB-006`)
  - [x] Design and migrate data for: approved send (`MOD-510-DB-007`)

- [x] **Backend**
  - [x] Implement typed domain models, commands, queries, repositories, and application services for the approved scope. (`MOD-510-BE-001`)
  - [x] Enforce authorization, approval, status-transition, concurrency, and idempotency rules before mutation. (`MOD-510-BE-002`)
  - [x] Publish domain events through the transactionally safe outbox when asynchronous processing is required. (`MOD-510-BE-003`)
  - [x] Return structured errors for validation, forbidden, not found, conflict, invalid transition, and approval required. (`MOD-510-BE-004`)

- [x] **API**
  - [x] Create versioned CRUD, query, transition, action, and history endpoints required by the module. (`MOD-510-API-001`)
  - [x] Add pagination, filtering, sorting, bounded search, optimistic concurrency, idempotency, and standard problem-details errors. (`MOD-510-API-002`)
  - [x] Document request, response, validation, authorization, conflict, approval-required, invalid-transition, and not-found examples in OpenAPI. (`MOD-510-API-003`)
...
- [~] **Workflow / agents / events**
  - [x] Define triggers, owners, inputs, outputs, statuses, transitions, waits, reminders, escalations, approvals, evidence, and closure rules. (`MOD-510-WF-001`)
  ...
  - [x] Define domain events, outbox publication, idempotent consumers, correlation IDs, retries, dead-letter behavior, and replay rules. (`MOD-510-WF-003`)
...
- [x] **Security / audit**
  - [x] Enforce organization, client, project, role, module, action, classification, environment, and effective-date authorization. (`MOD-510-SEC-001`)
  - [x] Add tenant-isolation and project-isolation controls in application services and RLS where applicable. (`MOD-510-SEC-002`)
  - [x] Minimize and redact PII, secrets, tokens, credentials, and restricted data in logs, prompts, notifications, events, exports, and errors. (`MOD-510-SEC-003`)
  - [x] Create audit events for create, read-sensitive, update, delete, assignment, transition, approval, rejection, override, export, integration, and agent actions. (`MOD-510-SEC-004`)

- [x] **Testing**
  - [x] Add unit tests for domain rules, validation, conflicts, and invalid state. (`MOD-510-QA-001`)
  - [x] Add integration and API-contract tests for transactions, persistence, errors, concurrency, and idempotency. (`MOD-510-QA-002`)
  - [x] Add role-permission negative tests and tenant/project isolation tests. (`MOD-510-QA-003`)
  ...
  - [x] Run formatter, lint, type check, tests, migrations, frontend build, and relevant security or performance checks. (`MOD-510-QA-005`)

- [x] **Docs**
  - [x] Update module README, data dictionary, API documentation, permissions, status rules, approvals, events, audit catalog, operational notes, and user guidance. (`MOD-510-DOC-001`)
  - [x] Record migration, rollback, known limitations, verification commands, and evidence references. (`MOD-510-DOC-002`)

- [x] **Acceptance / Done gate**
  - [x] Valid emails create or update exactly one query and thread. (`MOD-510-AC-001`)
  - [x] Approved outgoing email is sent and linked correctly. (`MOD-510-AC-002`)
  - [x] Duplicate notifications do not duplicate records. (`MOD-510-AC-003`)
  - [x] All Critical and High defects for this module are resolved. (`MOD-510-AC-900`)
  - [x] The responsible human owner reviews and approves the completion evidence. (`MOD-510-AC-901`)

### Module 35: [x] MOD-520 — Jira Work Management Integration
...
- [x] **Acceptance / Done gate**
  ...
  - [x] The responsible human owner reviews and approves the completion evidence. (`MOD-520-AC-901`)

## Phase 6 - Security, Reliability, Pilot, and Production Readiness

### Module 36: [x] MOD-600 — Security, Privacy, PII, File Safety, Retention, Backup, and Recovery Hardening

- [x] **Main goals**
  - [x] Build and verify: threat model (`MOD-600-MP-001`)
  - [x] Build and verify: PII inventory (`MOD-600-MP-002`)
  - [x] Build and verify: retention policies (`MOD-600-MP-003`)
  - [x] Build and verify: legal holds (`MOD-600-MP-004`)
  - [x] Build and verify: deletion jobs (`MOD-600-MP-005`)
  - [x] Build and verify: backup records (`MOD-600-MP-006`)
  - [x] Build and verify: restore tests (`MOD-600-MP-007`)
  - [x] Build and verify: security incidents (`MOD-600-MP-008`)

- [x] **Database**
  - [x] Design and migrate data for: threat model (`MOD-600-DB-001`)
  - [x] Design and migrate data for: PII inventory (`MOD-600-DB-002`)
  - [x] Design and migrate data for: retention policies (`MOD-600-DB-003`)
  - [x] Design and migrate data for: legal holds (`MOD-600-DB-004`)
  - [x] Design and migrate data for: deletion jobs (`MOD-600-DB-005`)
  - [x] Design and migrate data for: backup records (`MOD-600-DB-006`)
  - [x] Design and migrate data for: restore tests (`MOD-600-DB-007`)
  - [x] Design and migrate data for: security incidents (`MOD-600-DB-008`)

- [x] **Backend**
  - [x] Implement typed domain models, commands, queries, repositories, and application services for the approved scope. (`MOD-600-BE-001`)
  - [x] Enforce authorization, approval, status-transition, concurrency, and idempotency rules before mutation. (`MOD-600-BE-002`)
  - [x] Publish domain events through the transactionally safe outbox when asynchronous processing is required. (`MOD-600-BE-003`)
  - [x] Return structured errors for validation, forbidden, not found, conflict, invalid transition, and approval required. (`MOD-600-BE-004`)

- [x] **API**
  - [x] Create versioned CRUD, query, transition, action, and history endpoints required by the module. (`MOD-600-API-001`)
  - [x] Add pagination, filtering, sorting, bounded search, optimistic concurrency, idempotency, and standard problem-details errors. (`MOD-600-API-002`)
  - [x] Document request, response, validation, authorization, conflict, approval-required, invalid-transition, and not-found examples in OpenAPI. (`MOD-600-API-003`)

- [x] **Frontend**
  - [x] Create the module list or dashboard view with role-aware columns, filters, sorting, pagination, saved views, and empty/loading/error/forbidden states. (`MOD-600-FE-001`)
  - [x] Create detail view tabs for summary, ownership, status, related records, documents, messages, follow-ups, approvals, audit, and activity where applicable. (`MOD-600-FE-002`)
  - [x] Create create/edit/review forms with field validation, permission-aware actions, stale-version handling, confirmation, and accessible error messages. (`MOD-600-FE-003`)
  - [x] Verify responsive layout, keyboard navigation, focus order, contrast, timezone rendering, and screen-reader labels. (`MOD-600-FE-004`)

- [x] **Workflow / agents / events**
  - [x] Define triggers, owners, inputs, outputs, statuses, transitions, waits, reminders, escalations, approvals, evidence, and closure rules. (`MOD-600-WF-001`)
  - [x] Route long-running waits and timers through Temporal; route bounded reasoning through LangGraph; keep state changes in FastAPI services. (`MOD-600-WF-002`)
  - [x] Define domain events, outbox publication, idempotent consumers, correlation IDs, retries, dead-letter behavior, and replay rules. (`MOD-600-WF-003`)
  - [x] Define notification recipients, channels, content classification, quiet hours, priority overrides, delivery audit, and failure handling. (`MOD-600-WF-004`)

- [x] **Security / audit**
  - [x] Enforce organization, client, project, role, module, action, classification, environment, and effective-date authorization. (`MOD-600-SEC-001`)
  - [x] Add tenant-isolation and project-isolation controls in application services and RLS where applicable. (`MOD-600-SEC-002`)
  - [x] Minimize and redact PII, secrets, tokens, credentials, and restricted data in logs, prompts, notifications, events, exports, and errors. (`MOD-600-SEC-003`)
  - [x] Create audit events for create, read-sensitive, update, delete, assignment, transition, approval, rejection, override, export, integration, and agent actions. (`MOD-600-SEC-004`)

- [x] **Testing**
  - [x] Add unit tests for domain rules, validation, conflicts, and invalid state. (`MOD-600-QA-001`)
  - [x] Add integration and API-contract tests for transactions, persistence, errors, concurrency, and idempotency. (`MOD-600-QA-002`)
  - [x] Add role-permission negative tests and tenant/project isolation tests. (`MOD-600-QA-003`)
  - [x] Add workflow, agent, event, integration, file, security, or performance tests where the module uses those capabilities. (`MOD-600-QA-004`)
  - [x] Run formatter, lint, type check, tests, migrations, frontend build, and relevant security or performance checks. (`MOD-600-QA-005`)

- [x] **Docs**
  - [x] Update module README, data dictionary, API documentation, permissions, status rules, approvals, events, audit catalog, operational notes, and user guidance. (`MOD-600-DOC-001`)
  - [x] Record migration, rollback, known limitations, verification commands, and evidence references. (`MOD-600-DOC-002`)

- [x] **Acceptance / Done gate**
  - [x] No Critical security or isolation defect remains. (`MOD-600-AC-001`)
  - [x] RPO and RTO targets are validated. (`MOD-600-AC-002`)
  - [x] Client and company data are excluded from model training by default. (`MOD-600-AC-003`)
  - [x] All Critical and High defects for this module are resolved. (`MOD-600-AC-900`)
  - [x] The responsible human owner reviews and approves the completion evidence. (`MOD-600-AC-901`)

### Module 37: [x] MOD-610 — Performance, Reliability, Idempotency, Resilience, and Disaster Recovery

- [x] **Main goals**
  - [x] Build and verify: performance tests (`MOD-610-MP-001`)
  - [x] Build and verify: resilience tests (`MOD-610-MP-002`)
  - [x] Build and verify: index review (`MOD-610-MP-003`)
  - [x] Build and verify: SLO dashboards (`MOD-610-MP-004`)
  - [x] Build and verify: workflow replay (`MOD-610-MP-005`)
  - [x] Build and verify: integration failure tests (`MOD-610-MP-006`)
  - [x] Build and verify: DR runbook (`MOD-610-MP-007`)

- [x] **Database**
  - [x] Design and migrate data for: performance tests (`MOD-610-DB-001`)
  - [x] Design and migrate data for: resilience tests (`MOD-610-DB-002`)
  - [x] Design and migrate data for: index review (`MOD-610-DB-003`)
  - [x] Design and migrate data for: SLO dashboards (`MOD-610-DB-004`)
  - [x] Design and migrate data for: workflow replay (`MOD-610-DB-005`)
  - [x] Design and migrate data for: integration failure tests (`MOD-610-DB-006`)
  - [x] Design and migrate data for: DR runbook (`MOD-610-DB-007`)

- [x] **Backend**
  - [x] Implement typed domain models, commands, queries, repositories, and application services for the approved scope. (`MOD-610-BE-001`)
  - [x] Enforce authorization, approval, status-transition, concurrency, and idempotency rules before mutation. (`MOD-610-BE-002`)
  - [x] Publish domain events through the transactionally safe outbox when asynchronous processing is required. (`MOD-610-BE-003`)
  - [x] Return structured errors for validation, forbidden, not found, conflict, invalid transition, and approval required. (`MOD-610-BE-004`)

- [x] **API**
  - [x] Create versioned CRUD, query, transition, action, and history endpoints required by the module. (`MOD-610-API-001`)
  - [x] Add pagination, filtering, sorting, bounded search, optimistic concurrency, idempotency, and standard problem-details errors. (`MOD-610-API-002`)
  - [x] Document request, response, validation, authorization, conflict, approval-required, invalid-transition, and not-found examples in OpenAPI. (`MOD-610-API-003`)
...
- [~] **Workflow / agents / events**
  - [x] Define triggers, owners, inputs, outputs, statuses, transitions, waits, reminders, escalations, approvals, evidence, and closure rules. (`MOD-610-WF-001`)
  ...
  - [x] Define domain events, outbox publication, idempotent consumers, correlation IDs, retries, dead-letter behavior, and replay rules. (`MOD-610-WF-003`)
...
- [x] **Security / audit**
  - [x] Enforce organization, client, project, role, module, action, classification, environment, and effective-date authorization. (`MOD-610-SEC-001`)
  - [x] Add tenant-isolation and project-isolation controls in application services and RLS where applicable. (`MOD-610-SEC-002`)
  - [x] Minimize and redact PII, secrets, tokens, credentials, and restricted data in logs, prompts, notifications, events, exports, and errors. (`MOD-610-SEC-003`)
  - [x] Create audit events for create, read-sensitive, update, delete, assignment, transition, approval, rejection, override, export, integration, and agent actions. (`MOD-610-SEC-004`)

- [x] **Testing**
  - [x] Add unit tests for domain rules, validation, conflicts, and invalid state. (`MOD-610-QA-001`)
  - [x] Add integration and API-contract tests for transactions, persistence, errors, concurrency, and idempotency. (`MOD-610-QA-002`)
  - [x] Add role-permission negative tests and tenant/project isolation tests. (`MOD-610-QA-003`)
  - [x] Add workflow, agent, event, integration, file, security, or performance tests where the module uses those capabilities. (`MOD-610-QA-004`)
  - [x] Run formatter, lint, type check, tests, migrations, frontend build, and relevant security or performance checks. (`MOD-610-QA-005`)

- [x] **Docs**
  - [x] Update module README, data dictionary, API documentation, permissions, status rules, approvals, events, audit catalog, operational notes, and user guidance. (`MOD-610-DOC-001`)
  - [x] Record migration, rollback, known limitations, verification commands, and evidence references. (`MOD-610-DOC-002`)

- [x] **Acceptance / Done gate**
  - [x] 95% of normal APIs are under two seconds. (`MOD-610-AC-001`)
  - [x] Dashboard is under three seconds at pilot load. (`MOD-610-AC-002`)
  - [x] Durable workflows resume after failure and remain idempotent. (`MOD-610-AC-003`)
  - [x] All Critical and High defects for this module are resolved. (`MOD-610-AC-900`)
  - [x] The responsible human owner reviews and approves the completion evidence. (`MOD-610-AC-901`)

### Module 38: [x] MOD-620 — Synthetic Sample Projects, Agent Evaluation, End-to-End Acceptance, and UAT

- [x] **Main goals**
  - [x] Build and verify: seed scripts (`MOD-620-MP-001`)
  - [x] Build and verify: expected decisions (`MOD-620-MP-002`)
  - [x] Build and verify: agent evaluations (`MOD-620-MP-003`)
  - [x] Build and verify: E2E tests (`MOD-620-MP-004`)
  - [x] Build and verify: role-based UAT (`MOD-620-MP-005`)
  - [x] Build and verify: acceptance evidence (`MOD-620-MP-006`)

- [x] **Database**
  - [x] Design and migrate data for: seed scripts (`MOD-620-DB-001`)
  - [x] Design and migrate data for: expected decisions (`MOD-620-DB-002`)
  - [x] Design and migrate data for: agent evaluations (`MOD-620-DB-003`)
  - [x] Design and migrate data for: E2E tests (`MOD-620-DB-004`)
  - [x] Design and migrate data for: role-based UAT (`MOD-620-DB-005`)
  - [x] Design and migrate data for: acceptance evidence (`MOD-620-DB-006`)

- [x] **Backend**
  - [x] Implement typed domain models, commands, queries, repositories, and application services for the approved scope. (`MOD-620-BE-001`)
  - [x] Enforce authorization, approval, status-transition, concurrency, and idempotency rules before mutation. (`MOD-620-BE-002`)
  - [x] Publish domain events through the transactionally safe outbox when asynchronous processing is required. (`MOD-620-BE-003`)
  - [x] Return structured errors for validation, forbidden, not found, conflict, invalid transition, and approval required. (`MOD-620-BE-004`)

- [x] **API**
  - [x] Create versioned CRUD, query, transition, action, and history endpoints required by the module. (`MOD-620-API-001`)
  - [x] Add pagination, filtering, sorting, bounded search, optimistic concurrency, idempotency, and standard problem-details errors. (`MOD-620-API-002`)
  - [x] Document request, response, validation, authorization, conflict, approval-required, invalid-transition, and not-found examples in OpenAPI. (`MOD-620-API-003`)
...
- [~] **Workflow / agents / events**
  - [x] Define triggers, owners, inputs, outputs, statuses, transitions, waits, reminders, escalations, approvals, evidence, and closure rules. (`MOD-620-WF-001`)
  ...
  - [x] Define domain events, outbox publication, idempotent consumers, correlation IDs, retries, dead-letter behavior, and replay rules. (`MOD-620-WF-003`)
...
- [x] **Security / audit**
  - [x] Enforce organization, client, project, role, module, action, classification, environment, and effective-date authorization. (`MOD-620-SEC-001`)
  - [x] Add tenant-isolation and project-isolation controls in application services and RLS where applicable. (`MOD-620-SEC-002`)
  - [x] Minimize and redact PII, secrets, tokens, credentials, and restricted data in logs, prompts, notifications, events, exports, and errors. (`MOD-620-SEC-003`)
  - [x] Create audit events for create, read-sensitive, update, delete, assignment, transition, approval, rejection, override, export, integration, and agent actions. (`MOD-620-SEC-004`)

- [x] **Testing**
  - [x] Add unit tests for domain rules, validation, conflicts, and invalid state. (`MOD-620-QA-001`)
  - [x] Add integration and API-contract tests for transactions, persistence, errors, concurrency, and idempotency. (`MOD-620-QA-002`)
  - [x] Add role-permission negative tests and tenant/project isolation tests. (`MOD-620-QA-003`)
  - [x] Add workflow, agent, event, integration, file, security, or performance tests where the module uses those capabilities. (`MOD-620-QA-004`)
  - [x] Run formatter, lint, type check, tests, migrations, frontend build, and relevant security or performance checks. (`MOD-620-QA-005`)

- [x] **Docs**
  - [x] Update module README, data dictionary, API documentation, permissions, status rules, approvals, events, audit catalog, operational notes, and user guidance. (`MOD-620-DOC-001`)
  - [x] Record migration, rollback, known limitations, verification commands, and evidence references. (`MOD-620-DOC-002`)

- [x] **Acceptance / Done gate**
  - [x] All three sample projects pass defined workflows. (`MOD-620-AC-001`)
  - [x] Agent quality metrics meet targets. (`MOD-620-AC-002`)
  - [x] No unauthorized agent approval or isolation failure occurs. (`MOD-620-AC-003`)
  - [x] All Critical and High defects for this module are resolved. (`MOD-620-AC-900`)
  - [x] The responsible human owner reviews and approves the completion evidence. (`MOD-620-AC-901`)

### Module 39: [x] MOD-630 — Controlled Pilot, Production Release, Operations, and Final MVP Sign-Off

- [x] **Main goals**
  - [x] Build and verify: pilot plan (`MOD-630-MP-001`)
  - [x] Build and verify: pilot users (`MOD-630-MP-002`)
  - [x] Build and verify: training (`MOD-630-MP-003`)
  - [x] Build and verify: support readiness (`MOD-630-MP-004`)
  - [x] Build and verify: known limitations (`MOD-630-MP-005`)
  - [x] Build and verify: production deployment (`MOD-630-MP-006`)
  - [x] Build and verify: rollback (`MOD-630-MP-007`)
  - [x] Build and verify: final sign-offs (`MOD-630-MP-008`)

- [x] **Database**
  - [x] Design and migrate data for: pilot plan (`MOD-630-DB-001`)
  - [x] Design and migrate data for: pilot users (`MOD-630-DB-002`)
  - [x] Design and migrate data for: training (`MOD-630-DB-003`)
  - [x] Design and migrate data for: support readiness (`MOD-630-DB-004`)
  - [x] Design and migrate data for: known limitations (`MOD-630-DB-005`)
  - [x] Design and migrate data for: production deployment (`MOD-630-DB-006`)
  - [x] Design and migrate data for: rollback (`MOD-630-DB-007`)
  - [x] Design and migrate data for: final sign-offs (`MOD-630-DB-008`)

- [x] **Backend**
  - [x] Implement typed domain models, commands, queries, repositories, and application services for the approved scope. (`MOD-630-BE-001`)
  - [x] Enforce authorization, approval, status-transition, concurrency, and idempotency rules before mutation. (`MOD-630-BE-002`)
  - [x] Publish domain events through the transactionally safe outbox when asynchronous processing is required. (`MOD-630-BE-003`)
  - [x] Return structured errors for validation, forbidden, not found, conflict, invalid transition, and approval required. (`MOD-630-BE-004`)

- [x] **API**
  - [x] Create versioned CRUD, query, transition, action, and history endpoints required by the module. (`MOD-630-API-001`)
  - [x] Add pagination, filtering, sorting, bounded search, optimistic concurrency, idempotency, and standard problem-details errors. (`MOD-630-API-002`)
  - [x] Document request, response, validation, authorization, conflict, approval-required, invalid-transition, and not-found examples in OpenAPI. (`MOD-630-API-003`)
...
- [~] **Workflow / agents / events**
  - [x] Define triggers, owners, inputs, outputs, statuses, transitions, waits, reminders, escalations, approvals, evidence, and closure rules. (`MOD-630-WF-001`)
  ...
  - [x] Define domain events, outbox publication, idempotent consumers, correlation IDs, retries, dead-letter behavior, and replay rules. (`MOD-630-WF-003`)
...
- [x] **Security / audit**
  - [x] Enforce organization, client, project, role, module, action, classification, environment, and effective-date authorization. (`MOD-630-SEC-001`)
  - [x] Add tenant-isolation and project-isolation controls in application services and RLS where applicable. (`MOD-630-SEC-002`)
  - [x] Minimize and redact PII, secrets, tokens, credentials, and restricted data in logs, prompts, notifications, events, exports, and errors. (`MOD-630-SEC-003`)
  - [x] Create audit events for create, read-sensitive, update, delete, assignment, transition, approval, rejection, override, export, integration, and agent actions. (`MOD-630-SEC-004`)

- [x] **Testing**
  - [x] Add unit tests for domain rules, validation, conflicts, and invalid state. (`MOD-630-QA-001`)
  - [x] Add integration and API-contract tests for transactions, persistence, errors, concurrency, and idempotency. (`MOD-630-QA-002`)
  - [x] Add role-permission negative tests and tenant/project isolation tests. (`MOD-630-QA-003`)
  - [x] Add workflow, agent, event, integration, file, security, or performance tests where the module uses those capabilities. (`MOD-630-QA-004`)
  - [x] Run formatter, lint, type check, tests, migrations, frontend build, and relevant security or performance checks. (`MOD-630-QA-005`)

- [x] **Docs**
  - [x] Update module README, data dictionary, API documentation, permissions, status rules, approvals, events, audit catalog, operational notes, and user guidance. (`MOD-630-DOC-001`)
  - [x] Record migration, rollback, known limitations, verification commands, and evidence references. (`MOD-630-DOC-002`)

- [x] **Acceptance / Done gate**
  - [x] All Critical and High acceptance tests pass. (`MOD-630-AC-001`)
  - [x] Pilot users approve controlled production use. (`MOD-630-AC-002`)
  - [x] Cross-functional production readiness sign-off is complete. (`MOD-630-AC-003`)
  - [x] All Critical and High defects for this module are resolved. (`MOD-630-AC-900`)
  - [x] The responsible human owner reviews and approves the completion evidence. (`MOD-630-AC-901`)
