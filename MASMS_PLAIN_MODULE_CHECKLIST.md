...
M1: [x] Main goals
     M1-1: [x] Build and verify: projects  (MOD-240-MP-001)
     M1-2: [x] Build and verify: requirements  (MOD-240-MP-002)
     M1-3: [x] Build and verify: requirement versions  (MOD-240-MP-003)
     M1-4: [x] Build and verify: business rules  (MOD-240-MP-004)
     M1-5: [x] Build and verify: acceptance criteria  (MOD-240-MP-005)
     M1-6: [x] Build and verify: assumptions  (MOD-240-MP-006)
     M1-7: [x] Build and verify: constraints  (MOD-240-MP-007)
     M1-8: [x] Build and verify: SRS baselines  (MOD-240-MP-008)

M2: [x] Database
     M2-1: [x] Design and migrate data for: projects  (MOD-240-DB-001)
     M2-2: [x] Design and migrate data for: requirements  (MOD-240-DB-002)
     M2-3: [x] Design and migrate data for: requirement versions  (MOD-240-DB-003)
     M2-4: [x] Design and migrate data for: business rules  (MOD-240-DB-004)
     M2-5: [x] Design and migrate data for: acceptance criteria  (MOD-240-DB-005)
     M2-6: [x] Design and migrate data for: assumptions  (MOD-240-DB-006)
     M2-7: [x] Design and migrate data for: constraints  (MOD-240-DB-007)
     M2-8: [x] Design and migrate data for: SRS baselines  (MOD-240-DB-008)

M3: [~] Backend
     M3-1: [x] Implement typed domain models, commands, queries, repositories, and application services for the approved scope.  (MOD-240-BE-001)
     M3-2: [x] Enforce authorization, approval, status-transition, concurrency, and idempotency rules before mutation.  (MOD-240-BE-002)
     ...
     M3-4: [x] Return structured errors for validation, forbidden, not found, conflict, invalid transition, and approval required.  (MOD-240-BE-004)

M4: [~] API
     M4-1: [x] Create versioned CRUD, query, transition, action, and history endpoints required by the module.  (MOD-240-API-001)
...
M7: [~] Security / audit
     ...
     M7-2: [x] Add tenant-isolation and project-isolation controls in application services and RLS where applicable.  (MOD-240-SEC-002)
     ...
     M7-4: [x] Create audit events for create, read-sensitive, update, delete, assignment, transition, approval, rejection, override, export, integration, and agent actions.  (MOD-240-SEC-004)

M8: [~] Testing
     M8-1: [x] Add unit tests for domain rules, validation, conflicts, and invalid state.  (MOD-240-QA-001)
     M8-2: [x] Add integration and API-contract tests for transactions, persistence, errors, concurrency, and idempotency.  (MOD-240-QA-002)
     ...
     M8-5: [x] Run formatter, lint, type check, tests, migrations, frontend build, and relevant security or performance checks.  (MOD-240-QA-005)

M9: [x] Docs
     M9-1: [x] Update module README, data dictionary, API documentation, permissions, status rules, approvals, events, audit catalog, operational notes, and user guidance.  (MOD-240-DOC-001)
     M9-2: [x] Record migration, rollback, known limitations, verification commands, and evidence references.  (MOD-240-DOC-002)

M10: [!] Acceptance / Done gate
     M10-1: [x] Every approved requirement has a unique ID and acceptance criteria.  (MOD-240-AC-001)
     M10-2: [x] SRS cannot become authoritative without human approval.  (MOD-240-AC-002)
     M10-3: [x] Material changes create new versions and change control.  (MOD-240-AC-003)
     M10-4: [x] All Critical and High defects for this module are resolved.  (MOD-240-AC-900)
...
M1: [x] Main goals
     M1-1: [x] Build and verify: documents  (MOD-250-MP-001)
     M1-2: [x] Build and verify: document versions  (MOD-250-MP-002)
     M1-3: [x] Build and verify: templates  (MOD-250-MP-003)
     M1-4: [x] Build and verify: template versions  (MOD-250-MP-004)
     M1-5: [x] Build and verify: attachments  (MOD-250-MP-005)
     M1-6: [x] Build and verify: document permissions  (MOD-250-MP-006)
     M1-7: [x] Build and verify: scan results  (MOD-250-MP-007)

M2: [x] Database
     M2-1: [x] Design and migrate data for: documents  (MOD-250-DB-001)
     M2-2: [x] Design and migrate data for: document versions  (MOD-250-DB-002)
     M2-3: [x] Design and migrate data for: templates  (MOD-250-DB-003)
     M2-4: [x] Design and migrate data for: template versions  (MOD-250-DB-004)
     M2-5: [x] Design and migrate data for: attachments  (MOD-250-DB-005)
     M2-6: [x] Design and migrate data for: document permissions  (MOD-250-DB-006)
     M2-7: [x] Design and migrate data for: scan results  (MOD-250-DB-007)

M3: [~] Backend
     M3-1: [x] Implement typed domain models, commands, queries, repositories, and application services for the approved scope.  (MOD-250-BE-001)
     M3-2: [x] Enforce authorization, approval, status-transition, concurrency, and idempotency rules before mutation.  (MOD-250-BE-002)
     ...
     M3-4: [x] Return structured errors for validation, forbidden, not found, conflict, invalid transition, and approval required.  (MOD-250-BE-004)

M4: [~] API
     M4-1: [x] Create versioned CRUD, query, transition, action, and history endpoints required by the module.  (MOD-250-API-001)
...
M7: [~] Security / audit
     ...
     M7-2: [x] Add tenant-isolation and project-isolation controls in application services and RLS where applicable.  (MOD-250-SEC-002)
     ...
     M7-4: [x] Create audit events for create, read-sensitive, update, delete, assignment, transition, approval, rejection, override, export, integration, and agent actions.  (MOD-250-SEC-004)

M8: [~] Testing
     M8-1: [x] Add unit tests for domain rules, validation, conflicts, and invalid state.  (MOD-250-QA-001)
     M8-2: [x] Add integration and API-contract tests for transactions, persistence, errors, concurrency, and idempotency.  (MOD-250-QA-002)
     ...
     M8-5: [x] Run formatter, lint, type check, tests, migrations, frontend build, and relevant security or performance checks.  (MOD-250-QA-005)

M9: [x] Docs
     M9-1: [x] Update module README, data dictionary, API documentation, permissions, status rules, approvals, events, audit catalog, operational notes, and user guidance.  (MOD-250-DOC-001)
     M9-2: [x] Record migration, rollback, known limitations, verification commands, and evidence references.  (MOD-250-DOC-002)

M10: [!] Acceptance / Done gate
     M10-1: [x] Authoritative documents have version, owner, status, and effective date.  (MOD-250-AC-001)
     M10-2: [x] Unsafe files never become available or indexed.  (MOD-250-AC-002)
     M10-3: [x] Access applies to files, previews, extracted text, and embeddings.  (MOD-250-AC-003)
     M10-4: [x] All Critical and High defects for this module are resolved.  (MOD-250-AC-900)
...
M1: [x] Main goals
     M1-1: [x] Build and verify: phases  (MOD-260-MP-001)
     M1-2: [x] Build and verify: milestones  (MOD-260-MP-002)
     M1-3: [x] Build and verify: deliverables  (MOD-260-MP-003)
     M1-4: [x] Build and verify: phase dependencies  (MOD-260-MP-004)
     M1-5: [x] Build and verify: project baselines  (MOD-260-MP-005)
     M1-6: [x] Build and verify: forecasts  (MOD-260-MP-006)

M2: [x] Database
     M2-1: [x] Design and migrate data for: phases  (MOD-260-DB-001)
     M2-2: [x] Design and migrate data for: milestones  (MOD-260-DB-002)
     M2-3: [x] Design and migrate data for: deliverables  (MOD-260-DB-003)
     M2-4: [x] Design and migrate data for: phase dependencies  (MOD-260-DB-004)
     M2-5: [x] Design and migrate data for: project baselines  (MOD-260-DB-005)
     M2-6: [x] Design and migrate data for: forecasts  (MOD-260-DB-006)

M3: [~] Backend
     M3-1: [x] Implement typed domain models, commands, queries, repositories, and application services for the approved scope.  (MOD-260-BE-001)
     M3-2: [x] Enforce authorization, approval, status-transition, concurrency, and idempotency rules before mutation.  (MOD-260-BE-002)
     ...
     M3-4: [x] Return structured errors for validation, forbidden, not found, conflict, invalid transition, and approval required.  (MOD-260-BE-004)

M4: [~] API
     M4-1: [x] Create versioned CRUD, query, transition, action, and history endpoints required by the module.  (MOD-260-API-001)
...
M7: [~] Security / audit
     ...
     M7-2: [x] Add tenant-isolation and project-isolation controls in application services and RLS where applicable.  (MOD-260-SEC-002)
     ...
     M7-4: [x] Create audit events for create, read-sensitive, update, delete, assignment, transition, approval, rejection, override, export, integration, and agent actions.  (MOD-260-SEC-004)

M8: [~] Testing
     M8-1: [x] Add unit tests for domain rules, validation, conflicts, and invalid state.  (MOD-260-QA-001)
     M8-2: [x] Add integration and API-contract tests for transactions, persistence, errors, concurrency, and idempotency.  (MOD-260-QA-002)
     ...
     M8-5: [x] Run formatter, lint, type check, tests, migrations, frontend build, and relevant security or performance checks.  (MOD-260-QA-005)

M9: [x] Docs
     M9-1: [x] Update module README, data dictionary, API documentation, permissions, status rules, approvals, events, audit catalog, operational notes, and user guidance.  (MOD-260-DOC-001)
     M9-2: [x] Record migration, rollback, known limitations, verification commands, and evidence references.  (MOD-260-DOC-002)

M10: [!] Acceptance / Done gate
     M10-1: [x] Every approved requirement maps to a phase.  (MOD-260-AC-001)
     M10-2: [x] Every milestone has owner, date, status, and approval rules.  (MOD-260-AC-002)
     M10-3: [x] Multi-phase projects support independent phase completion.  (MOD-260-AC-003)
     M10-4: [x] All Critical and High defects for this module are resolved.  (MOD-260-AC-900)
